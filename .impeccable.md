...
5. **Consistent Component Language**: All components share the same border-radius (6px default, 8px marketing), shadow depth (border-only with 0.08 alpha), and spacing (4px base unit).
...
### Border Radius
```css
--geist-radius: 6px           /* default (inputs, cards) */
--geist-marketing-radius: 8px /* marketing cards */
...
- Border-radius: 6px (right side when paired with icon)
