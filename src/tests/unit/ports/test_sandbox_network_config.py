...
class TestSandboxNetworkSecurity:
    ...
    def test_block_sensitive_ports(self) -> None:
        ...
        config = SandboxConfig(blocked_ports=sensitive_ports)
    ...
    def test_container_network_mode(self) -> None:
        """应该支持连接到另一个容器网络."""
        config = SandboxConfig(network_mode="container:another-container")
    ...
    def test_security_profile_network_mapping(self) -> None:
        ...
        standard_config = SandboxConfig(security_profile="standard")
