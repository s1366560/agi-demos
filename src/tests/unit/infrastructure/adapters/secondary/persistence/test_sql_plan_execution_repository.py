...
@pytest.fixture
async def v2_plan_execution_repo(v2_db_session: AsyncSession) -> SqlPlanExecutionRepository:
    """Create a V2 plan execution repository for testing."""
    return SqlPlanExecutionRepository(v2_db_session)
...
class TestSqlPlanExecutionRepositoryCreate:
    """Tests for creating plan executions."""

    @pytest.mark.asyncio
    async def test_save_new_execution(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
...
class TestSqlPlanExecutionRepositoryFind:
    """Tests for finding executions."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
        """Test finding a non-existent execution returns None."""
        result = await v2_plan_execution_repo.find_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_find_by_plan_id(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_conversation(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_conversation_with_status(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_active_by_conversation(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
...
class TestSqlPlanExecutionRepositoryUpdate:
    """Tests for updating executions."""

    @pytest.mark.asyncio
    async def test_update_status(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_status_nonexistent(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_step(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_step_nonexistent(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
        """Test updating step of non-existent execution returns None."""
        result = await v2_plan_execution_repo.update_step("non-existent", 0, {})
        assert result is None


class TestSqlPlanExecutionRepositoryDelete:
    """Tests for deleting executions."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_plan_execution_repo: SqlPlanExecutionRepository):
