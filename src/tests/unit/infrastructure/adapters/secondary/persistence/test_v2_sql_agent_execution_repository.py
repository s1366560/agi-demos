...
from src.infrastructure.adapters.secondary.persistence.v2_sql_agent_execution_repository import (
    V2SqlAgentExecutionRepository,
)


@pytest.fixture
async def v2_agent_execution_repo(v2_db_session: AsyncSession) -> V2SqlAgentExecutionRepository:
    """Create a V2 agent execution repository for testing."""
    return V2SqlAgentExecutionRepository(v2_db_session)


class TestV2SqlAgentExecutionRepositoryCreate:
    """Tests for creating new agent executions."""

    @pytest.mark.asyncio
    async def test_save_new_execution(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_with_minimal_fields(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
...
class TestV2SqlAgentExecutionRepositoryUpdate:
    """Tests for updating existing executions."""

    @pytest.mark.asyncio
    async def test_update_existing_execution(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
...
class TestV2SqlAgentExecutionRepositoryFind:
    """Tests for finding executions."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
        """Test finding a non-existent execution returns None."""
        retrieved = await v2_agent_execution_repo.find_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_list_by_message(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_conversation(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_conversation_with_limit(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
...
class TestV2SqlAgentExecutionRepositoryDelete:
    """Tests for deleting executions."""

    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
...
class TestV2SqlAgentExecutionRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
    ...
    def test_to_domain_with_none_db_model(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_agent_execution_repo._to_domain(None)
        assert result is None


class TestV2SqlAgentExecutionRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
...
class TestV2SqlAgentExecutionRepositoryEdgeCases:
    """Tests for edge cases and error handling."""

    @pytest.mark.asyncio
    async def test_empty_tool_input_defaults_to_empty_dict(
        self, v2_agent_execution_repo: V2SqlAgentExecutionRepository
    ):
    ...
    @pytest.mark.asyncio
    async def test_status_enum_conversion(self, v2_agent_execution_repo: V2SqlAgentExecutionRepository):
