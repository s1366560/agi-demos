...
class TestSqlMessageRepositorySave:
    ...
    @pytest.mark.asyncio
    async def test_save_message_with_tool_calls(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_message_with_tool_results(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_and_commit(self, v2_message_repo: SqlMessageRepository):
...
class TestSqlMessageRepositoryFind:
    """Tests for finding messages."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_message_repo: SqlMessageRepository):
        """Test finding a non-existent message returns None."""
        retrieved = await v2_message_repo.find_by_id("non-existent")
        assert retrieved is None


class TestSqlMessageRepositoryList:
    """Tests for listing messages."""

    @pytest.mark.asyncio
    async def test_list_by_conversation(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_conversation_ordered(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_recent_by_project(self, v2_message_repo: SqlMessageRepository):
...
class TestSqlMessageRepositoryCount:
    ...
    @pytest.mark.asyncio
    async def test_count_by_conversation(self, v2_message_repo: SqlMessageRepository):
...
class TestSqlMessageRepositoryDelete:
    """Tests for deleting messages."""

    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_message_repo: SqlMessageRepository):
...
class TestSqlMessageRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_message_repo: SqlMessageRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_message_repo._to_domain(None)
        assert result is None


class TestSqlMessageRepositoryTransaction:
    """Tests for transaction support."""

    @pytest.mark.asyncio
    async def test_transaction_context_manager(self, v2_message_repo: SqlMessageRepository):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback_on_error(self, v2_message_repo: SqlMessageRepository):
