...
from src.infrastructure.adapters.secondary.persistence.v2_sql_tool_execution_record_repository import (
    V2SqlToolExecutionRecordRepository,
)


@pytest.fixture
async def v2_tool_record_repo(v2_db_session: AsyncSession) -> V2SqlToolExecutionRecordRepository:
    """Create a V2 tool execution record repository for testing."""
    return V2SqlToolExecutionRecordRepository(v2_db_session)


class TestV2SqlToolExecutionRecordRepositoryCreate:
    """Tests for creating tool execution records."""

    @pytest.mark.asyncio
    async def test_save_new_record(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
...
class TestV2SqlToolExecutionRecordRepositoryFind:
    """Tests for finding records."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
        """Test finding a non-existent record returns None."""
        result = await v2_tool_record_repo.find_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_find_by_call_id(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_message(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_conversation(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
...
class TestV2SqlToolExecutionRecordRepositoryUpdate:
    """Tests for updating records."""

    @pytest.mark.asyncio
    async def test_update_status(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
...
class TestV2SqlToolExecutionRecordRepositoryDelete:
    """Tests for deleting records."""

    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_tool_record_repo: V2SqlToolExecutionRecordRepository):
