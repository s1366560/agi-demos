...
from src.infrastructure.adapters.secondary.persistence.v2_sql_execution_checkpoint_repository import (
    V2SqlExecutionCheckpointRepository,
)


@pytest.fixture
async def v2_checkpoint_repo(v2_db_session: AsyncSession) -> V2SqlExecutionCheckpointRepository:
    """Create a V2 execution checkpoint repository for testing."""
    return V2SqlExecutionCheckpointRepository(v2_db_session)


class TestV2SqlExecutionCheckpointRepositoryCreate:
    """Tests for creating checkpoints."""

    @pytest.mark.asyncio
    async def test_save_new_checkpoint(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_without_message_id(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
...
class TestV2SqlExecutionCheckpointRepositoryFind:
    """Tests for finding checkpoints."""

    @pytest.mark.asyncio
    async def test_get_latest(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_latest_none_when_empty(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_type(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_type_with_limit(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
...
class TestV2SqlExecutionCheckpointRepositoryDelete:
    """Tests for deleting checkpoints."""

    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
...
class TestV2SqlExecutionCheckpointRepositoryToDomain:
    """Tests for _to_domain conversion."""

    def test_to_domain_with_none(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_checkpoint_repo._to_domain(None)
        assert result is None

    @pytest.mark.asyncio
    async def test_to_domain_handles_empty_state(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
...
class TestV2SqlExecutionCheckpointRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_checkpoint_repo: V2SqlExecutionCheckpointRepository):
