...
from src.infrastructure.adapters.secondary.persistence.v2_sql_mcp_server_repository import (
    V2SqlMCPServerRepository,
)


@pytest.fixture
async def v2_mcp_repo(db_session: AsyncSession, test_tenant_db: DBTenant) -> V2SqlMCPServerRepository:
    """Create a V2 MCP server repository for testing."""
    return V2SqlMCPServerRepository(db_session)
...
class TestV2SqlMCPServerRepositoryCreate:
    """Tests for creating MCP servers."""

    @pytest.mark.asyncio
    async def test_create_server(self, v2_mcp_repo: V2SqlMCPServerRepository):
...
class TestV2SqlMCPServerRepositoryGet:
    """Tests for getting MCP servers."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_mcp_repo: V2SqlMCPServerRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_mcp_repo: V2SqlMCPServerRepository):
        """Test getting a non-existent server returns None."""
        server = await v2_mcp_repo.get_by_id("non-existent")
        assert server is None

    @pytest.mark.asyncio
    async def test_get_by_name_existing(self, v2_mcp_repo: V2SqlMCPServerRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_name_not_found(self, v2_mcp_repo: V2SqlMCPServerRepository):
        """Test getting by non-existent name returns None."""
        server = await v2_mcp_repo.get_by_name("tenant-test-1", "non-existent-name")
        assert server is None


class TestV2SqlMCPServerRepositoryList:
    """Tests for listing MCP servers."""

    @pytest.mark.asyncio
    async def test_list_by_tenant(self, v2_mcp_repo: V2SqlMCPServerRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tenant_enabled_only(self, v2_mcp_repo: V2SqlMCPServerRepository):
...
class TestV2SqlMCPServerRepositoryUpdate:
    """Tests for updating MCP servers."""

    @pytest.mark.asyncio
    async def test_update_server(self, v2_mcp_repo: V2SqlMCPServerRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_nonexistent_server(self, v2_mcp_repo: V2SqlMCPServerRepository):
        """Test updating a non-existent server returns False."""
        result = await v2_mcp_repo.update("non-existent", name="New Name")
        assert result is False

    @pytest.mark.asyncio
    async def test_update_discovered_tools(self, v2_mcp_repo: V2SqlMCPServerRepository):
...
class TestV2SqlMCPServerRepositoryDelete:
    """Tests for deleting MCP servers."""

    @pytest.mark.asyncio
    async def test_delete_server(self, v2_mcp_repo: V2SqlMCPServerRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_server(self, v2_mcp_repo: V2SqlMCPServerRepository):
        """Test deleting a non-existent server returns False."""
        result = await v2_mcp_repo.delete("non-existent")
        assert result is False


class TestV2SqlMCPServerRepositoryGetEnabledServers:
    """Tests for getting enabled servers."""

    @pytest.mark.asyncio
    async def test_get_enabled_servers(self, v2_mcp_repo: V2SqlMCPServerRepository):
