...
@pytest.fixture
async def v2_skill_config_repo(v2_db_session: AsyncSession) -> SqlTenantSkillConfigRepository:
    """Create a V2 tenant skill config repository for testing."""
    return SqlTenantSkillConfigRepository(v2_db_session)


class TestSqlTenantSkillConfigRepositoryCreate:
    """Tests for creating skill configs."""

    @pytest.mark.asyncio
    async def test_create_new_config(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
...
class TestSqlTenantSkillConfigRepositoryFind:
    """Tests for finding skill configs."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
...
class TestSqlTenantSkillConfigRepositoryUpdate:
...
class TestSqlTenantSkillConfigRepositoryDelete:
    """Tests for deleting skill configs."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
...
class TestSqlTenantSkillConfigRepositoryList:
    """Tests for listing skill configs."""

    @pytest.mark.asyncio
    async def test_list_by_tenant(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_configs_map(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_by_tenant(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
...
class TestSqlTenantSkillConfigRepositoryToDomain:
    """Tests for _to_domain conversion."""

    def test_to_domain_with_none(self, v2_skill_config_repo: SqlTenantSkillConfigRepository):
