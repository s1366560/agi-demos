...
@pytest.fixture
async def v2_tenant_repo(db_session: AsyncSession, test_owner_db: DBUser) -> SqlTenantRepository:
    """Create a V2 tenant repository for testing."""
    return SqlTenantRepository(db_session)
...
class TestSqlTenantRepositorySave:
    """Tests for saving tenants."""

    @pytest.mark.asyncio
    async def test_save_new_tenant(self, v2_tenant_repo: SqlTenantRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_existing_tenant(self, v2_tenant_repo: SqlTenantRepository):
...
class TestSqlTenantRepositoryFind:
    """Tests for finding tenants."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_tenant_repo: SqlTenantRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_tenant_repo: SqlTenantRepository):
        """Test finding a non-existent tenant returns None."""
        retrieved = await v2_tenant_repo.find_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_find_by_name_existing(self, v2_tenant_repo: SqlTenantRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_name_not_found(self, v2_tenant_repo: SqlTenantRepository):
        """Test finding by non-existent name returns None."""
        retrieved = await v2_tenant_repo.find_by_name("non-existent-name")
        assert retrieved is None


class TestSqlTenantRepositoryList:
    ...
    @pytest.mark.asyncio
    async def test_list_all_with_pagination(self, v2_tenant_repo: SqlTenantRepository):
...
class TestSqlTenantRepositoryDelete:
    """Tests for deleting tenants."""

    @pytest.mark.asyncio
    async def test_delete_existing_tenant(self, v2_tenant_repo: SqlTenantRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_tenant(self, v2_tenant_repo: SqlTenantRepository):
        """Test deleting a non-existent tenant does not raise error."""
        # Should not raise error
        await v2_tenant_repo.delete("non-existent")


class TestSqlTenantRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_tenant_repo: SqlTenantRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_tenant_repo: SqlTenantRepository):
