...
@pytest.fixture
async def v2_user_repo(db_session: AsyncSession) -> SqlUserRepository:
    """Create a V2 user repository for testing."""
    return SqlUserRepository(db_session)


class TestSqlUserRepositoryCreate:
    """Tests for creating new users."""

    @pytest.mark.asyncio
    async def test_create_new_user(self, v2_user_repo: SqlUserRepository):
...
class TestSqlUserRepositoryUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_existing_user(self, v2_user_repo: SqlUserRepository):
...
class TestSqlUserRepositoryFind:
    """Tests for finding users."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_user_repo: SqlUserRepository):
        """Test finding a non-existent user returns None."""
        retrieved = await v2_user_repo.find_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_find_by_email_existing(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_email_not_found(self, v2_user_repo: SqlUserRepository):
        """Test finding a non-existent user by email returns None."""
        retrieved = await v2_user_repo.find_by_email("nonexistent@example.com")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_exists_true(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_false(self, v2_user_repo: SqlUserRepository):
        """Test exists returns False for non-existent user."""
        assert await v2_user_repo.exists("non-existent") is False


class TestSqlUserRepositoryList:
    """Tests for listing users."""

    @pytest.mark.asyncio
    async def test_list_all(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_all_with_pagination(self, v2_user_repo: SqlUserRepository):
...
class TestSqlUserRepositoryDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_existing_user(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_user(self, v2_user_repo: SqlUserRepository):
        """Test deleting a non-existent user returns False."""
        result = await v2_user_repo.delete("non-existent")
        assert result is False


class TestSqlUserRepositoryCount:
    """Tests for counting users."""

    @pytest.mark.asyncio
    async def test_count_all(self, v2_user_repo: SqlUserRepository):
...
class TestSqlUserRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_user_repo: SqlUserRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_user_repo._to_domain(None)
        assert result is None


class TestSqlUserRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_user_repo: SqlUserRepository):
...
class TestSqlUserRepositoryTransaction:
    ...
    @pytest.mark.asyncio
    async def test_transaction_context_manager(self, v2_user_repo: SqlUserRepository):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback_on_error(self, v2_user_repo: SqlUserRepository):
