...
from src.infrastructure.adapters.secondary.persistence.v2_sql_tool_composition_repository import (
    V2SqlToolCompositionRepository,
)


@pytest.fixture
async def v2_composition_repo(v2_db_session: AsyncSession) -> V2SqlToolCompositionRepository:
    """Create a V2 tool composition repository for testing."""
    return V2SqlToolCompositionRepository(v2_db_session)


class TestV2SqlToolCompositionRepositoryCreate:
    """Tests for creating tool compositions."""

    @pytest.mark.asyncio
    async def test_save_new_composition(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_composition_repo: V2SqlToolCompositionRepository):
...
class TestV2SqlToolCompositionRepositoryFind:
    """Tests for finding compositions."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_composition_repo: V2SqlToolCompositionRepository):
        """Test getting a non-existent composition returns None."""
        result = await v2_composition_repo.get_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_get_by_name(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tools(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_all(self, v2_composition_repo: V2SqlToolCompositionRepository):
...
class TestV2SqlToolCompositionRepositoryUpdateUsage:
    """Tests for updating usage statistics."""

    @pytest.mark.asyncio
    async def test_update_usage_success(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_usage_failure(self, v2_composition_repo: V2SqlToolCompositionRepository):
...
class TestV2SqlToolCompositionRepositoryDelete:
    """Tests for deleting compositions."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_composition_repo: V2SqlToolCompositionRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_composition_repo: V2SqlToolCompositionRepository):
