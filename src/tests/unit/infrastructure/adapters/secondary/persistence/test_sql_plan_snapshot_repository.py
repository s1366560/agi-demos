...
@pytest.fixture
async def v2_plan_snapshot_repo(v2_db_session: AsyncSession) -> SqlPlanSnapshotRepository:
    """Create a V2 plan snapshot repository for testing."""
    return SqlPlanSnapshotRepository(v2_db_session)
...
class TestSqlPlanSnapshotRepositoryCreate:
    """Tests for creating snapshots."""

    @pytest.mark.asyncio
    async def test_save_new_snapshot(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_auto_created_snapshot(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
...
class TestSqlPlanSnapshotRepositoryFind:
    """Tests for finding snapshots."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
        """Test finding a non-existent snapshot returns None."""
        result = await v2_plan_snapshot_repo.find_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_find_by_execution(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_latest_by_execution(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_latest_by_execution_empty(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
...
class TestSqlPlanSnapshotRepositoryDelete:
    """Tests for deleting snapshots."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
        """Test deleting a non-existent snapshot returns False."""
        result = await v2_plan_snapshot_repo.delete("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_delete_by_execution(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
...
class TestSqlPlanSnapshotRepositoryStepStates:
    """Tests for step state handling."""

    @pytest.mark.asyncio
    async def test_save_and_retrieve_step_states(self, v2_plan_snapshot_repo: SqlPlanSnapshotRepository):
