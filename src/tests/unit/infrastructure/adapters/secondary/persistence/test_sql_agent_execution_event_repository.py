...
@pytest.fixture
async def v2_event_repo(db_session: AsyncSession) -> SqlAgentExecutionEventRepository:
    """Create a V2 agent execution event repository for testing."""
    return SqlAgentExecutionEventRepository(db_session)
...
class TestSqlAgentExecutionEventRepositorySave:
    """Tests for saving events."""

    @pytest.mark.asyncio
    async def test_save_new_event(self, v2_event_repo: SqlAgentExecutionEventRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_idempotent(self, v2_event_repo: SqlAgentExecutionEventRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_and_commit(self, v2_event_repo: SqlAgentExecutionEventRepository):
...
class TestSqlAgentExecutionEventRepositorySaveBatch:
    """Tests for batch saving events."""

    @pytest.mark.asyncio
    async def test_save_batch(self, v2_event_repo: SqlAgentExecutionEventRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_batch_empty(self, v2_event_repo: SqlAgentExecutionEventRepository):
...
class TestSqlAgentExecutionEventRepositoryGetEvents:
...
class TestSqlAgentExecutionEventRepositoryGetLastSequence:
    """Tests for getting last sequence number."""

    @pytest.mark.asyncio
    async def test_get_last_sequence_empty(self, v2_event_repo: SqlAgentExecutionEventRepository):
...
class TestSqlAgentExecutionEventRepositoryGetEventsByMessage:
...
class TestSqlAgentExecutionEventRepositoryDeleteByConversation:
...
class TestSqlAgentExecutionEventRepositoryListByConversation:
...
class TestSqlAgentExecutionEventRepositoryGetMessageEvents:
...
class TestSqlAgentExecutionEventRepositoryCountMessages:
    """Tests for counting messages."""

    @pytest.mark.asyncio
    async def test_count_messages(self, v2_event_repo: SqlAgentExecutionEventRepository):
...
class TestSqlAgentExecutionEventRepositoryToDomain:
