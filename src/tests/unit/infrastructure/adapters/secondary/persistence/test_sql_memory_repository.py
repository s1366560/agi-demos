...
class TestSqlMemoryRepositoryCreate:
    ...
    @pytest.mark.asyncio
    async def test_save_new_memory(self, v2_memory_repo: SqlMemoryRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_with_tags_and_entities(self, v2_memory_repo: SqlMemoryRepository):
...
class TestSqlMemoryRepositoryUpdate:
    """Tests for updating memories."""

    @pytest.mark.asyncio
    async def test_update_existing_memory(self, v2_memory_repo: SqlMemoryRepository):
...
class TestSqlMemoryRepositoryFind:
    """Tests for finding memories."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_memory_repo: SqlMemoryRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_memory_repo: SqlMemoryRepository):
        """Test finding a non-existent memory returns None."""
        retrieved = await v2_memory_repo.find_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_list_by_project(self, v2_memory_repo: SqlMemoryRepository):
...
class TestSqlMemoryRepositoryDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_existing_memory(self, v2_memory_repo: SqlMemoryRepository):
...
class TestSqlMemoryRepositoryToDomain:
    """Tests for _to_domain conversion."""

    def test_to_domain_with_none(self, v2_memory_repo: SqlMemoryRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_memory_repo._to_domain(None)
        assert result is None


class TestSqlMemoryRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_memory_repo: SqlMemoryRepository):
