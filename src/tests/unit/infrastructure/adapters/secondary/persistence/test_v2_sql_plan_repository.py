...
from src.infrastructure.adapters.secondary.persistence.v2_sql_plan_repository import (
    V2SqlPlanRepository,
)


@pytest.fixture
async def v2_plan_repo(v2_db_session: AsyncSession) -> V2SqlPlanRepository:
    """Create a V2 plan repository for testing."""
    return V2SqlPlanRepository(v2_db_session)
...
class TestV2SqlPlanRepositoryCreate:
    """Tests for creating plans."""

    @pytest.mark.asyncio
    async def test_save_new_plan(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_plan_repo: V2SqlPlanRepository):
...
class TestV2SqlPlanRepositoryFind:
    """Tests for finding plans."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_plan_repo: V2SqlPlanRepository):
        """Test finding a non-existent plan returns None."""
        result = await v2_plan_repo.find_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_find_by_conversation_id(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_conversation_with_status(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_active_by_conversation(self, v2_plan_repo: V2SqlPlanRepository):
...
class TestV2SqlPlanRepositoryDelete:
    """Tests for deleting plans."""

    @pytest.mark.asyncio
    async def test_delete_by_id(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_plan_repo: V2SqlPlanRepository):
...
class TestV2SqlPlanRepositoryUpdate:
    """Tests for updating plans."""

    @pytest.mark.asyncio
    async def test_update_content(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_content_nonexistent(self, v2_plan_repo: V2SqlPlanRepository):
        """Test updating content of non-existent plan returns None."""
        result = await v2_plan_repo.update_content("non-existent", "content")
        assert result is None

    @pytest.mark.asyncio
    async def test_update_status(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_status_nonexistent(self, v2_plan_repo: V2SqlPlanRepository):
...
class TestV2SqlPlanRepositoryCount:
    """Tests for counting plans."""

    @pytest.mark.asyncio
    async def test_count_by_conversation(self, v2_plan_repo: V2SqlPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_empty_conversation(self, v2_plan_repo: V2SqlPlanRepository):
