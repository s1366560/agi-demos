...
@pytest.fixture
async def v2_skill_repo(db_session: AsyncSession) -> V2SqlSkillRepository:
    """Create a V2 skill repository for testing."""
    return V2SqlSkillRepository(db_session)
...
class TestV2SqlSkillRepositoryCreate:
    """Tests for creating new skills."""

    @pytest.mark.asyncio
    async def test_create_new_skill(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryFind:
    """Tests for finding skills."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_skill_repo: V2SqlSkillRepository):
        """Test finding a non-existent skill returns None."""
        retrieved = await v2_skill_repo.get_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_get_by_name_existing(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_name_with_scope(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_name_not_found(self, v2_skill_repo: V2SqlSkillRepository):
        """Test getting a non-existent skill by name returns None."""
        retrieved = await v2_skill_repo.get_by_name("tenant-1", "nonexistent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_exists_true(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_false(self, v2_skill_repo: V2SqlSkillRepository):
        """Test exists returns False for non-existent skill."""
        assert await v2_skill_repo.exists("non-existent") is False


class TestV2SqlSkillRepositoryUpdate:
    """Tests for updating skills."""

    @pytest.mark.asyncio
    async def test_update_existing_skill(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_nonexistent_raises_error(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryList:
    """Tests for listing skills."""

    @pytest.mark.asyncio
    async def test_list_by_tenant(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tenant_with_status_filter(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tenant_with_scope_filter(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tenant_with_pagination(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_project(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_project_with_filters(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryDelete:
    """Tests for deleting skills."""

    @pytest.mark.asyncio
    async def test_delete_existing_skill(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_raises_error(self, v2_skill_repo: V2SqlSkillRepository):
        """Test deleting a non-existent skill raises ValueError."""
        with pytest.raises(ValueError, match="Skill not found"):
            await v2_skill_repo.delete("non-existent")


class TestV2SqlSkillRepositoryFindMatching:
    """Tests for finding matching skills."""

    @pytest.mark.asyncio
    async def test_find_matching_skills(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryIncrementUsage:
    """Tests for incrementing usage statistics."""

    @pytest.mark.asyncio
    async def test_increment_usage_success(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_increment_usage_failure(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_increment_nonexistent_raises_error(self, v2_skill_repo: V2SqlSkillRepository):
        """Test incrementing a non-existent skill raises ValueError."""
        with pytest.raises(ValueError, match="Skill not found"):
            await v2_skill_repo.increment_usage("non-existent", success=True)


class TestV2SqlSkillRepositoryCount:
    """Tests for counting skills."""

    @pytest.mark.asyncio
    async def test_count_by_tenant(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_by_tenant_with_status_filter(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_by_tenant_with_scope_filter(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_skill_repo: V2SqlSkillRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_skill_repo._to_domain(None)
        assert result is None


class TestV2SqlSkillRepositoryTransaction:
    """Tests for transaction support."""

    @pytest.mark.asyncio
    async def test_transaction_context_manager(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback_on_error(self, v2_skill_repo: V2SqlSkillRepository):
...
class TestV2SqlSkillRepositoryCountAll:
    """Tests for count method from BaseRepository."""

    @pytest.mark.asyncio
    async def test_count_all(self, v2_skill_repo: V2SqlSkillRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_with_filters(self, v2_skill_repo: V2SqlSkillRepository):
