...
from src.infrastructure.adapters.secondary.persistence.v2_sql_work_plan_repository import (
    V2SqlWorkPlanRepository,
)


@pytest.fixture
async def v2_work_plan_repo(v2_db_session: AsyncSession) -> V2SqlWorkPlanRepository:
    """Create a V2 work plan repository for testing."""
    return V2SqlWorkPlanRepository(v2_db_session)
...
class TestV2SqlWorkPlanRepositoryCreate:
    """Tests for creating work plans."""

    @pytest.mark.asyncio
    async def test_save_new_plan(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
...
class TestV2SqlWorkPlanRepositoryFind:
    """Tests for finding plans."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
        """Test getting a non-existent plan returns None."""
        result = await v2_work_plan_repo.get_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_get_by_conversation(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_active_by_conversation(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
...
class TestV2SqlWorkPlanRepositoryDelete:
    """Tests for deleting plans."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
        """Test deleting a non-existent plan returns False."""
        result = await v2_work_plan_repo.delete("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_delete_by_conversation(self, v2_work_plan_repo: V2SqlWorkPlanRepository):
