...
@pytest.fixture
async def v2_attachment_repo(v2_db_session: AsyncSession) -> V2SqlAttachmentRepository:
    """Create a V2 attachment repository for testing."""
    return V2SqlAttachmentRepository(v2_db_session)


class TestV2SqlAttachmentRepositoryCreate:
    """Tests for creating new attachments."""

    @pytest.mark.asyncio
    async def test_save_new_attachment(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_with_expiration(self, v2_attachment_repo: V2SqlAttachmentRepository):
...
class TestV2SqlAttachmentRepositoryUpdate:
    """Tests for updating existing attachments."""

    @pytest.mark.asyncio
    async def test_update_existing_attachment(self, v2_attachment_repo: V2SqlAttachmentRepository):
...
class TestV2SqlAttachmentRepositoryFind:
    """Tests for finding attachments."""

    @pytest.mark.asyncio
    async def test_get_existing(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_not_found(self, v2_attachment_repo: V2SqlAttachmentRepository):
        """Test finding a non-existent attachment returns None."""
        retrieved = await v2_attachment_repo.get("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_get_by_conversation(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_conversation_with_status_filter(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_ids(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_ids_empty_list(self, v2_attachment_repo: V2SqlAttachmentRepository):
        """Test getting attachments with empty ID list returns empty list."""
        attachments = await v2_attachment_repo.get_by_ids([])
        assert attachments == []


class TestV2SqlAttachmentRepositoryDelete:
    """Tests for deleting attachments."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_attachment_repo: V2SqlAttachmentRepository):
        """Test deleting a non-existent attachment returns False."""
        result = await v2_attachment_repo.delete("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_delete_expired(self, v2_attachment_repo: V2SqlAttachmentRepository):
...
class TestV2SqlAttachmentRepositoryUpdateMethods:
    """Tests for specific update methods."""

    @pytest.mark.asyncio
    async def test_update_status(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_status_with_error(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_upload_progress(self, v2_attachment_repo: V2SqlAttachmentRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_sandbox_path(self, v2_attachment_repo: V2SqlAttachmentRepository):
...
class TestV2SqlAttachmentRepositoryToDomain:
    """Tests for _to_domain conversion."""

    def test_to_domain_with_none(self, v2_attachment_repo: V2SqlAttachmentRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_attachment_repo._to_domain(None)
        assert result is None

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_attachment_repo: V2SqlAttachmentRepository):
...
class TestV2SqlAttachmentRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_attachment_repo: V2SqlAttachmentRepository):
