...
@pytest.fixture
async def v2_sandbox_repo(v2_db_session: AsyncSession) -> SqlProjectSandboxRepository:
    """Create a V2 project sandbox repository for testing."""
    return SqlProjectSandboxRepository(v2_db_session)
...
class TestSqlProjectSandboxRepositoryCreate:
    """Tests for creating sandbox associations."""

    @pytest.mark.asyncio
    async def test_save_new_sandbox(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_sandbox_repo: SqlProjectSandboxRepository):
...
class TestSqlProjectSandboxRepositoryFind:
    """Tests for finding sandbox associations."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_sandbox_repo: SqlProjectSandboxRepository):
        """Test finding a non-existent sandbox returns None."""
        result = await v2_sandbox_repo.find_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_find_by_project(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_sandbox(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_tenant(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_tenant_with_status(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_status(self, v2_sandbox_repo: SqlProjectSandboxRepository):
...
class TestSqlProjectSandboxRepositoryDelete:
    """Tests for deleting sandbox associations."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_sandbox_repo: SqlProjectSandboxRepository):
        """Test deleting a non-existent sandbox returns False."""
        result = await v2_sandbox_repo.delete("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_delete_by_project(self, v2_sandbox_repo: SqlProjectSandboxRepository):
...
class TestSqlProjectSandboxRepositoryUtility:
    """Tests for utility methods."""

    @pytest.mark.asyncio
    async def test_exists_for_project(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_by_tenant(self, v2_sandbox_repo: SqlProjectSandboxRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_by_tenant_with_status(self, v2_sandbox_repo: SqlProjectSandboxRepository):
...
class TestSqlProjectSandboxRepositoryStale:
