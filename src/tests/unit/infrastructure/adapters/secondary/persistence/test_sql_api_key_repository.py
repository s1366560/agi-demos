...
@pytest.fixture
async def v2_api_key_repo(db_session: AsyncSession, test_user_db: DBUser) -> SqlAPIKeyRepository:
    """Create a V2 API key repository for testing."""
    return SqlAPIKeyRepository(db_session)
...
class TestSqlAPIKeyRepositorySave:
    """Tests for saving API keys."""

    @pytest.mark.asyncio
    async def test_save_new_api_key(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_existing_api_key(self, v2_api_key_repo: SqlAPIKeyRepository):
...
class TestSqlAPIKeyRepositoryFind:
    """Tests for finding API keys."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_api_key_repo: SqlAPIKeyRepository):
        """Test finding a non-existent API key returns None."""
        retrieved = await v2_api_key_repo.find_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_find_by_hash_existing(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_hash_not_found(self, v2_api_key_repo: SqlAPIKeyRepository):
        """Test finding by non-existent hash returns None."""
        retrieved = await v2_api_key_repo.find_by_hash("nonexistent_hash")
        assert retrieved is None


class TestSqlAPIKeyRepositoryList:
    """Tests for listing API keys."""

    @pytest.mark.asyncio
    async def test_find_by_user(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_user_with_pagination(self, v2_api_key_repo: SqlAPIKeyRepository):
...
class TestSqlAPIKeyRepositoryDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_existing_key(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_key(self, v2_api_key_repo: SqlAPIKeyRepository):
...
class TestSqlAPIKeyRepositoryUpdateLastUsed:
    ...
    @pytest.mark.asyncio
    async def test_update_last_used(self, v2_api_key_repo: SqlAPIKeyRepository):
...
class TestSqlAPIKeyRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_api_key_repo: SqlAPIKeyRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_api_key_repo: SqlAPIKeyRepository):
