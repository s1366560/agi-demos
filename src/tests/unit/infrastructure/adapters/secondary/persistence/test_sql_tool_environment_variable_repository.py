...
@pytest.fixture
async def v2_env_var_repo(v2_db_session: AsyncSession) -> SqlToolEnvironmentVariableRepository:
    """Create a V2 tool environment variable repository for testing."""
    return SqlToolEnvironmentVariableRepository(v2_db_session)
...
class TestSqlToolEnvironmentVariableRepositoryCreate:
    """Tests for creating environment variables."""

    @pytest.mark.asyncio
    async def test_create_new_env_var(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
...
class TestSqlToolEnvironmentVariableRepositoryFind:
    """Tests for finding environment variables."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
        """Test getting a non-existent environment variable returns None."""
        result = await v2_env_var_repo.get_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_get_tenant_level(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_for_tool(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
...
class TestSqlToolEnvironmentVariableRepositoryUpdate:
    """Tests for updating environment variables."""

    @pytest.mark.asyncio
    async def test_update_existing(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
...
class TestSqlToolEnvironmentVariableRepositoryDelete:
    """Tests for deleting environment variables."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
...
class TestSqlToolEnvironmentVariableRepositoryUpsert:
    """Tests for upsert operations."""

    @pytest.mark.asyncio
    async def test_upsert_create(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
    ...
    @pytest.mark.asyncio
    async def test_upsert_update(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
...
class TestSqlToolEnvironmentVariableRepositoryList:
    """Tests for listing environment variables."""

    @pytest.mark.asyncio
    async def test_list_by_tenant(self, v2_env_var_repo: SqlToolEnvironmentVariableRepository):
