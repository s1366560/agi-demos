...
from src.infrastructure.adapters.secondary.persistence.v2_sql_tenant_agent_config_repository import (
    V2SqlTenantAgentConfigRepository,
)


@pytest.fixture
async def v2_config_repo(v2_db_session: AsyncSession) -> V2SqlTenantAgentConfigRepository:
    """Create a V2 tenant agent config repository for testing."""
    return V2SqlTenantAgentConfigRepository(v2_db_session)


class TestV2SqlTenantAgentConfigRepositoryCreate:
    """Tests for creating configurations."""

    @pytest.mark.asyncio
    async def test_save_new_config(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_updates_existing(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
...
class TestV2SqlTenantAgentConfigRepositoryFind:
    """Tests for finding configurations."""

    @pytest.mark.asyncio
    async def test_get_by_tenant_existing(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_tenant_not_found(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
...
class TestV2SqlTenantAgentConfigRepositoryDelete:
    """Tests for deleting configurations."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_raises_error(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
        """Test deleting a non-existent config raises ValueError."""
        with pytest.raises(ValueError):
            await v2_config_repo.delete("non-existent")


class TestV2SqlTenantAgentConfigRepositoryExists:
    """Tests for exists method."""

    @pytest.mark.asyncio
    async def test_exists_true(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_false(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
        """Test exists returns False for non-existent config."""
        assert await v2_config_repo.exists("non-existent") is False


class TestV2SqlTenantAgentConfigRepositoryToDomain:
    """Tests for _to_domain conversion."""

    def test_to_domain_with_none(self, v2_config_repo: V2SqlTenantAgentConfigRepository):
