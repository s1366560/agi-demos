...
@pytest.fixture
async def v2_pattern_repo(db_session: AsyncSession) -> V2SqlWorkflowPatternRepository:
    """Create a V2 workflow pattern repository for testing."""
    return V2SqlWorkflowPatternRepository(db_session)
...
class TestV2SqlWorkflowPatternRepositoryCreate:
    """Tests for creating new patterns."""

    @pytest.mark.asyncio
    async def test_create_new_pattern(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
...
class TestV2SqlWorkflowPatternRepositoryFind:
    """Tests for finding patterns."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
        """Test finding a non-existent pattern returns None."""
        retrieved = await v2_pattern_repo.get_by_id("non-existent")
        assert retrieved is None

    @pytest.mark.asyncio
    async def test_find_by_name_existing(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_name_not_found(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_true(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_false(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
        """Test exists returns False for non-existent pattern."""
        assert await v2_pattern_repo.exists("non-existent") is False


class TestV2SqlWorkflowPatternRepositoryUpdate:
    """Tests for updating patterns."""

    @pytest.mark.asyncio
    async def test_update_existing_pattern(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_nonexistent_raises_error(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
...
class TestV2SqlWorkflowPatternRepositoryList:
    """Tests for listing patterns."""

    @pytest.mark.asyncio
    async def test_list_by_tenant(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_by_tenant_orders_by_usage(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
...
class TestV2SqlWorkflowPatternRepositoryDelete:
    """Tests for deleting patterns."""

    @pytest.mark.asyncio
    async def test_delete_existing_pattern(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_raises_error(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
        """Test deleting a non-existent pattern raises ValueError."""
        with pytest.raises(ValueError, match="Pattern not found"):
            await v2_pattern_repo.delete("non-existent")


class TestV2SqlWorkflowPatternRepositoryIncrementUsage:
    """Tests for incrementing usage count."""

    @pytest.mark.asyncio
    async def test_increment_usage_count(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_increment_nonexistent_raises_error(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
        """Test incrementing a non-existent pattern raises ValueError."""
        with pytest.raises(ValueError, match="Pattern not found"):
            await v2_pattern_repo.increment_usage_count("non-existent")


class TestV2SqlWorkflowPatternRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_pattern_repo._to_domain(None)
        assert result is None


class TestV2SqlWorkflowPatternRepositoryStepConversion:
    """Tests for step conversion helpers."""

    def test_step_to_dict(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    def test_step_from_dict(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    def test_step_from_dict_with_defaults(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
...
class TestV2SqlWorkflowPatternRepositoryTransaction:
    """Tests for transaction support."""

    @pytest.mark.asyncio
    async def test_transaction_context_manager(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback_on_error(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
...
class TestV2SqlWorkflowPatternRepositoryCount:
    """Tests for counting patterns."""

    @pytest.mark.asyncio
    async def test_count_all(self, v2_pattern_repo: V2SqlWorkflowPatternRepository):
