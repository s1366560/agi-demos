...
@pytest.fixture
async def v2_hitl_repo(v2_db_session: AsyncSession) -> SqlHITLRequestRepository:
    """Create a V2 HITL request repository for testing."""
    return SqlHITLRequestRepository(v2_db_session)
...
class TestSqlHITLRequestRepositoryCreate:
    """Tests for creating HITL requests."""

    @pytest.mark.asyncio
    async def test_create_new_request(self, v2_hitl_repo: SqlHITLRequestRepository):
...
class TestSqlHITLRequestRepositoryFind:
    """Tests for finding HITL requests."""

    @pytest.mark.asyncio
    async def test_get_by_id_existing(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_not_found(self, v2_hitl_repo: SqlHITLRequestRepository):
        """Test getting a non-existent HITL request returns None."""
        result = await v2_hitl_repo.get_by_id("non-existent")
        assert result is None

    @pytest.mark.asyncio
    async def test_get_pending_by_conversation(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_get_pending_by_project(self, v2_hitl_repo: SqlHITLRequestRepository):
...
class TestSqlHITLRequestRepositoryUpdate:
    """Tests for updating HITL requests."""

    @pytest.mark.asyncio
    async def test_update_response(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_response_nonexistent(self, v2_hitl_repo: SqlHITLRequestRepository):
        """Test updating response of non-existent request returns None."""
        result = await v2_hitl_repo.update_response("non-existent", "yes")
        assert result is None

    @pytest.mark.asyncio
    async def test_mark_timeout(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_mark_cancelled(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_mark_completed(self, v2_hitl_repo: SqlHITLRequestRepository):
...
class TestSqlHITLRequestRepositoryUtility:
    """Tests for utility methods."""

    @pytest.mark.asyncio
    async def test_get_unprocessed_answered_requests(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_mark_expired_requests(self, v2_hitl_repo: SqlHITLRequestRepository):
...
class TestSqlHITLRequestRepositoryDelete:
    """Tests for deleting HITL requests."""

    @pytest.mark.asyncio
    async def test_delete_existing(self, v2_hitl_repo: SqlHITLRequestRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent(self, v2_hitl_repo: SqlHITLRequestRepository):
