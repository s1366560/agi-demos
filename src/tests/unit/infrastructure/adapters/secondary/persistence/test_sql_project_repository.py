...
@pytest.fixture
async def v2_project_repo(db_session: AsyncSession) -> SqlProjectRepository:
    """Create a V2 project repository for testing."""
    return SqlProjectRepository(db_session)


class TestSqlProjectRepositoryCreate:
    """Tests for creating new projects."""

    @pytest.mark.asyncio
    async def test_create_new_project(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_create_project_with_minimal_fields(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_save_with_none_project_raises_error(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_existing_project(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_update_preserves_tenant_and_owner(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryFind:
    """Tests for finding projects."""

    @pytest.mark.asyncio
    async def test_find_by_id_existing(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_exists_true(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryList:
    ...
    @pytest.mark.asyncio
    async def test_find_by_tenant_with_pagination(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_find_public_projects(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_list_all_with_filters(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_existing_project(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_project(self, v2_project_repo: SqlProjectRepository):
        """Test deleting a non-existent project returns False."""
        result = await v2_project_repo.delete("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_delete_empty_id_raises_error(self, v2_project_repo: SqlProjectRepository):
        """Test that deleting with empty ID doesn't raise but returns False."""
        result = await v2_project_repo.delete("")
        assert result is False


class TestSqlProjectRepositoryCount:
    """Tests for counting projects."""

    @pytest.mark.asyncio
    async def test_count_all(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_count_with_filter(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryToDomain:
    """Tests for _to_domain conversion."""

    @pytest.mark.asyncio
    async def test_to_domain_converts_all_fields(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_to_domain_with_none_db_model(self, v2_project_repo: SqlProjectRepository):
        """Test that _to_domain returns None for None input."""
        result = v2_project_repo._to_domain(None)
        assert result is None


class TestSqlProjectRepositoryToDb:
    """Tests for _to_db conversion."""

    def test_to_db_creates_db_model(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryTransaction:
    """Tests for transaction support."""

    @pytest.mark.asyncio
    async def test_transaction_context_manager(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback_on_error(self, v2_project_repo: SqlProjectRepository):
...
class TestSqlProjectRepositoryBulkOperations:
    """Tests for bulk operations."""

    @pytest.mark.asyncio
    async def test_bulk_save(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_bulk_delete(self, v2_project_repo: SqlProjectRepository):
    ...
    @pytest.mark.asyncio
    async def test_bulk_delete_empty_list(self, v2_project_repo: SqlProjectRepository):
