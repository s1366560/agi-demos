...
class ExecutionStep:
    ...
    def mark_started(self) -> "ExecutionStep":
        ...
        return replace(self, status=ExecutionStepStatus.RUNNING, started_at=datetime.now(timezone.utc))
...
class ExecutionPlan(Entity):
    ...
    def mark_executing(self) -> "ExecutionPlan":
        ...
        return replace(self, status=ExecutionPlanStatus.EXECUTING, started_at=datetime.now(timezone.utc))
