...
Review rules:
- Keep evidence inspection bounded. Once you have enough evidence for the verdict, stop using
  tools and submit workspace_submit_iteration_review in the same turn.
