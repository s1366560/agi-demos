...
class V2SqlExecutionCheckpointRepository(BaseRepository[ExecutionCheckpoint, DBExecutionCheckpoint], ExecutionCheckpointRepository):
    """
    V2 SQLAlchemy implementation of ExecutionCheckpointRepository using BaseRepository.
    ...
    def _to_domain(self, db_checkpoint: Optional[DBExecutionCheckpoint]) -> Optional[ExecutionCheckpoint]:
        """
