...
impl WorkspaceService for DevWorkspaceService {
    ...
    async fn get_plan_snapshot(
        ...
        self.dev_get_plan_snapshot(user_id, workspace_id, query)
            .await
    }
    ...
    async fn retry_plan_outbox(
        ...
        self.dev_retry_plan_outbox(user_id, workspace_id, outbox_id, body)
            .await
    }
    ...
    async fn recover_stale_attempts(
        ...
        self.dev_recover_stale_attempts(user_id, workspace_id, body)
            .await
    }
    ...
    async fn request_delivery_pipeline_run(
        ...
        self.dev_request_delivery_pipeline_run(user_id, workspace_id, body)
            .await
    }
    ...
    async fn request_delivery_contract_regeneration(
        ...
        self.dev_request_delivery_contract_regeneration(user_id, workspace_id, body)
            .await
    }
    ...
    async fn request_plan_node_replan(
        ...
        self.dev_request_plan_node_replan(user_id, workspace_id, node_id, body)
            .await
    }
    ...
    async fn reopen_plan_node(
        ...
        self.dev_reopen_plan_node(user_id, workspace_id, node_id, body)
            .await
    }
    ...
    async fn accept_plan_node_review(
        ...
        self.dev_accept_plan_node_review(user_id, workspace_id, node_id, body)
            .await
    }
    ...
    async fn list_files(
        ...
        self.dev_list_files(user_id, tenant_id, project_id, workspace_id, query)
            .await
    }
    ...
    async fn create_directory(
        ...
        self.dev_create_directory(user_id, tenant_id, project_id, workspace_id, body)
            .await
    }
    ...
    async fn upload_file(
        ...
        self.dev_upload_file(user_id, tenant_id, project_id, workspace_id, upload)
            .await
    }
    ...
    async fn download_file(
        ...
        self.dev_download_file(user_id, tenant_id, project_id, workspace_id, file_id)
            .await
    }
    ...
    async fn patch_file(
        ...
        self.dev_patch_file(user_id, tenant_id, project_id, workspace_id, file_id, body)
            .await
    }
    ...
    async fn copy_file(
        ...
        self.dev_copy_file(user_id, tenant_id, project_id, workspace_id, file_id, body)
            .await
    }
    ...
    async fn delete_file(
        ...
        self.dev_delete_file(user_id, tenant_id, project_id, workspace_id, file_id, query)
            .await
    }
}
