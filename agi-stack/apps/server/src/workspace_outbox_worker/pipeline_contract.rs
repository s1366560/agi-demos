...
impl PipelineContractFoundation {
    pub(super) fn can_create_sandbox_native_run(&self) -> bool {
    ...
    pub(super) fn can_execute_inline_stages(&self) -> bool {
...
pub(super) fn positive_i32_from_map(map: &Map<String, Value>, key: &str, default: i32) -> i32 {
    let parsed = map
        .get(key)
