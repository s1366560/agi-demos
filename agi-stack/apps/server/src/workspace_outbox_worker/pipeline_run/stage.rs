...
pub(crate) struct PipelineStageSpec {
    pub(in crate::workspace_outbox_worker) stage: String,
    pub(in crate::workspace_outbox_worker) command: String,
    pub(in crate::workspace_outbox_worker) required: bool,
    pub(in crate::workspace_outbox_worker) timeout_seconds: i32,
    pub(in crate::workspace_outbox_worker) service_id: Option<String>,
}
...
pub(crate) struct PipelineStageResult {
    ...
    pub(in crate::workspace_outbox_worker) command: String,
    pub(in crate::workspace_outbox_worker) exit_code: Option<i32>,
    pub(in crate::workspace_outbox_worker) stdout_preview: String,
    pub(in crate::workspace_outbox_worker) stderr_preview: String,
    pub(in crate::workspace_outbox_worker) duration_ms: i32,
    pub(in crate::workspace_outbox_worker) log_ref: Option<String>,
    pub(in crate::workspace_outbox_worker) artifact_refs: Vec<String>,
    pub(in crate::workspace_outbox_worker) service_id: Option<String>,
    pub(in crate::workspace_outbox_worker) required: bool,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct PipelineStageExecutionOutcome {
...
pub(super) async fn execute_sandbox_native_pipeline_stages(
