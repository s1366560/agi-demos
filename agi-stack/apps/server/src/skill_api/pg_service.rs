...
impl SkillService for PgSkillService {
    ...
    async fn get_evolution_config(
        ...
        self.get_evolution_config_for_user(user_id, tenant_id).await
    }
    ...
    async fn update_evolution_config(
        ...
        self.update_evolution_config_for_user(user_id, tenant_id, body)
            .await
    }
    ...
    async fn get_evolution_overview(
        ...
        self.evolution_overview_for_user(user_id, query).await
    }
    ...
    async fn get_evolution_detail(
        ...
        self.evolution_detail_for_user(user_id, query, skill_id)
            .await
    }
    ...
    async fn apply_evolution_job(
        ...
        self.apply_evolution_job_for_user(user_id, tenant_id, job_id)
            .await
    }
    ...
    async fn reject_evolution_job(
        ...
        self.reject_evolution_job_for_user(user_id, tenant_id, job_id)
            .await
    }
}
