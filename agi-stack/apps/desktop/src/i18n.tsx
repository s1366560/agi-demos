...
const enUS: Record<string, string> = {
  ...
  'workspaceCreate.genericError': 'The workspace could not be created. Review the details and retry.',
  ...
  'session.runtime.selectedEvidenceDescription': 'Latest structured fields for the selected resource or event.',
