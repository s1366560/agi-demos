...
const enUS: Record<string, string> = {
  ...
  'providers.identityDescription':
    'Manage credentials, endpoint health, models, and tenant routing independently.',
  ...
  'providers.routingEyebrow': 'TENANT ROUTING',
  ...
  'providers.tenantRoutingPolicy': 'Tenant routing policy',
  ...
  'providers.routingDescription':
    'Routing applies across the current tenant. Default and Coding are active in the local runtime.',
  'providers.savingRouting': 'Saving routing…',
  'providers.saveRouting': 'Save routing',
  'providers.routingSaved': 'Tenant routing policy saved.',
  ...
  'providers.fastModelDescription': 'Reserved for automatic titles and summaries',
  ...
  'providers.visionModelDescription': 'Reserved for future image-context analysis',
  'providers.roleRuntimeUnavailable': 'Not available in the current local runtime',
  ...
  'providers.routingUnavailableDescription':
    'The local runtime did not return an authoritative routing policy.',
  ...
  'providers.moveFallbackUp': 'Move fallback {count} up',
  'providers.moveFallbackDown': 'Move fallback {count} down',
  ...
  'providers.enableModelsDescription':
    'Enabled models become available to agents and tenant routing.',
...
const zhCN: Record<string, string> = {
  ...
  'providers.identityDescription': '分别管理供应商凭据、端点健康、可用模型与租户级路由。',
  ...
  'providers.routingEyebrow': '租户级路由',
  ...
  'providers.tenantRoutingPolicy': '租户级路由策略',
  ...
  'providers.routingDescription': '路由对当前租户内所有工作区生效；本地运行时当前启用默认与编程角色。',
  'providers.savingRouting': '正在保存路由…',
  'providers.saveRouting': '保存路由',
  'providers.routingSaved': '租户级路由策略已保存。',
  ...
  'providers.fastModelDescription': '预留给后续自动标题与摘要',
  'providers.codingModel': '编程模型',
  'providers.codingModelDescription': '代码库任务与代码审查',
  'providers.visionModel': '视觉模型',
  'providers.visionModelDescription': '预留给后续图像上下文分析',
  'providers.roleRuntimeUnavailable': '当前本地运行时尚未支持',
  'providers.routeUnavailable': '不可用',
  'providers.loadingRouting': '正在加载路由策略…',
  'providers.routingUnavailable': '路由策略不可用',
  'providers.routingUnavailableDescription': '本地运行时未返回权威路由策略。',
  ...
  'providers.moveFallbackUp': '上移第 {count} 个回退模型',
  'providers.moveFallbackDown': '下移第 {count} 个回退模型',
  ...
  'providers.enableModelsDescription': '启用后，模型会出现在智能体与租户级路由中。',
