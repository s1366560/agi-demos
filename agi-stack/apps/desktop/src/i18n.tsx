...
const enUS: Record<string, string> = {
  ...
  'providers.savingRouting': 'Applying runtime selection…',
  'providers.saveRouting': 'Save and use for local runtime',
...
const zhCN: Record<string, string> = {
  ...
  'providers.savingRouting': '正在应用运行时选择…',
  'providers.saveRouting': '保存并设为本地运行时',
