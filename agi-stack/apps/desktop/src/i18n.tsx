...
const enUS: Record<string, string> = {
  ...
  'myWork.description':
    'Runs that need your input, approval, monitoring, or final review from the authoritative project state.',
  'myWork.boardView': 'Board view',
  'myWork.backToQueue': 'Back to My Work',
  ...
  'myWork.commandDescription': 'Open project runs that need your attention.',
  'myWork.search': 'Search tasks',
  'myWork.refresh': 'Refresh My Work',
  'myWork.loading': 'Loading current runs',
  ...
  'myWork.empty': 'No runs need attention',
  'myWork.emptyDescription': 'New items appear here when a Run crosses a structured state boundary.',
  'myWork.noMatches': 'No matching runs',
  'myWork.noMatchesDescription': 'No runs match the current mode, search, and status filter.',
  ...
  'myWork.runRevision': 'Revision {revision}',
  'myWork.runRevisionLabel': 'Run revision',
  'myWork.lastHeartbeat': 'Last heartbeat',
  'myWork.persistedOnly': 'Persisted runtime data only',
  'myWork.actionRequired': 'Your action is required',
  'myWork.reviewAvailable': 'A result is ready for review',
  'myWork.runAuthority': 'RUN AUTHORITY',
  'myWork.currentRun': 'Current persisted run',
  'myWork.runAuthorityDescription':
    'Status, environment, permission, and revision come from the selected persisted Run. Open the session for messages, plan, evidence, and available actions.',
  ...
  'myWork.sessionUnavailable': 'The selected Run no longer has a loadable workspace session.',
...
const zhCN: Record<string, string> = {
  ...
  'myWork.eyebrow': '任务中枢',
  'myWork.title': '我的工作',
  'myWork.description': '根据项目权威状态，集中处理需要输入、批准、监控或最终审查的运行。',
  'myWork.boardView': '看板视图',
  'myWork.backToQueue': '返回我的工作',
  ...
  'myWork.mode': '模式',
  'myWork.queue': '项目工作队列',
  'myWork.commandDescription': '打开需要你关注的项目运行。',
  'myWork.search': '搜索任务',
  'myWork.refresh': '刷新我的工作',
  'myWork.loading': '正在加载当前运行',
  'myWork.loadingDescription': '正在读取项目权威关注队列。',
  'myWork.unavailable': '当前运行时未提供权威“我的工作”接口。',
  'myWork.empty': '目前没有需要关注的运行',
  'myWork.emptyDescription': '当 Run 进入结构化状态边界时，新项目会出现在这里。',
  'myWork.noMatches': '没有匹配的运行',
  'myWork.noMatchesDescription': '当前模式、搜索与状态筛选下没有匹配的运行。',
  ...
  'myWork.runRevision': '修订 {revision}',
  'myWork.runRevisionLabel': '运行修订',
  'myWork.lastHeartbeat': '最近心跳',
  'myWork.persistedOnly': '仅展示已持久化的运行数据',
  'myWork.actionRequired': '需要你处理',
  'myWork.reviewAvailable': '结果已可审查',
  'myWork.runAuthority': '运行权威数据',
  'myWork.currentRun': '当前已持久化运行',
  'myWork.runAuthorityDescription':
    '状态、环境、权限和修订均来自所选持久化 Run。打开会话可查看消息、计划、证据与后端授权的可用操作。',
  'myWork.openSession': '打开会话',
  'myWork.openSessionDescription': '进入会话，基于当前消息和后端授权操作继续处理。',
  'myWork.sessionUnavailable': '所选 Run 已没有可加载的工作空间会话。',
