...
const enUS: Record<string, string> = {
  ...
  'login.eyebrow': 'A DESKTOP HOME FOR AGENT WORK',
  'login.headline': 'Keep every task, run, and decision in one trusted workspace.',
  'login.description':
    'Move from a request to an approved plan, live execution, and reviewable evidence without losing context.',
  'login.kernelTitle': 'One execution kernel',
  'login.kernelDescription': 'General Agent and coding work share the same session model.',
  'login.reviewTitle': 'Human review is part of the flow',
  'login.reviewDescription': 'Plans, permissions, changes, and evidence stay visible before action.',
  'login.isolationTitle': 'Tenant and project isolation',
  'login.isolationDescription': 'Every request is bound to an authenticated workspace context.',
  'login.securityFooter': 'Session credentials stay on this device and can be revoked immediately.',
  'login.welcome': 'WELCOME BACK',
  'login.signInTitle': 'Sign in to MemStack',
  'login.localDescription': 'Continue with the trusted local desktop identity for this device.',
  'login.organizationDescription': 'Use your organization account to open its tenants and projects.',
  'login.continueLocal': 'Continue on this Mac',
  'login.workEmail': 'Work email',
  'login.password': 'Password',
  'login.passwordPlaceholder': 'Enter your password',
  'login.hidePassword': 'Hide password',
  'login.showPassword': 'Show password',
  'login.keepSignedIn': 'Keep me signed in on this trusted device',
  'login.signingIn': 'Signing in…',
  'login.signIn': 'Sign in',
  'login.legal': 'By continuing, you agree to your organization’s workspace and security policies.',
  'nav.home': 'Home',
  'nav.myWork': 'My Work',
...
const zhCN: Record<string, string> = {
  'login.agentWorkspace': '智能体工作空间',
  'login.eyebrow': '智能体工作的桌面入口',
  'login.headline': '在一个可信工作空间中管理每个任务、运行与决策。',
  'login.description': '从需求、计划批准到实时执行和证据审查，完整保留上下文。',
  'login.kernelTitle': '统一执行内核',
  'login.kernelDescription': '通用智能体与编程工作共享同一套会话模型。',
  'login.reviewTitle': '人工审查融入流程',
  'login.reviewDescription': '执行前清晰预览计划、权限、变更与证据。',
  'login.isolationTitle': '租户与项目隔离',
  'login.isolationDescription': '每个请求都绑定到已认证的工作空间上下文。',
  'login.securityFooter': '会话凭据仅保留在此设备，并可立即撤销。',
  'login.welcome': '欢迎回来',
  'login.signInTitle': '登录 MemStack',
  'login.localDescription': '使用此设备受信任的本地桌面身份继续。',
  'login.organizationDescription': '使用组织账户进入对应租户与项目。',
  'login.continueLocal': '在这台 Mac 上继续',
  'login.workEmail': '工作邮箱',
  'login.password': '密码',
  'login.passwordPlaceholder': '输入密码',
  'login.hidePassword': '隐藏密码',
  'login.showPassword': '显示密码',
  'login.keepSignedIn': '在此受信任设备上保持登录',
  'login.signingIn': '正在登录…',
  'login.signIn': '登录',
  'login.legal': '继续即表示你同意所在组织的工作空间与安全策略。',
  'nav.home': '首页',
  'nav.myWork': '我的工作',
  'nav.automations': '自动化',
  'nav.search': '搜索',
