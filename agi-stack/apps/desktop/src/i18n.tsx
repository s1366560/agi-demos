...
const enUS: Record<string, string> = {
  ...
  'providers.providerConfigured': '{provider} configuration is ready',
  ...
  'providers.auth.environmentDescription': 'Reference a runtime environment variable',
  ...
  'providers.environmentSecretDescription':
    'Only the variable name is saved. The secret value stays in the runtime environment and is never returned by the API.',
  ...
  'providers.configurationValidated': 'Configuration valid',
...
const zhCN: Record<string, string> = {
  ...
  'providers.providerConfigured': '{provider} 配置已就绪',
  ...
  'providers.auth.environmentDescription': '引用运行时环境变量',
  ...
  'providers.configurationValidated': '配置有效',
