...
const enUS: Record<string, string> = {
  ...
  'settings.aiResources': 'AGENT RESOURCES',
  'settings.account': 'Account',
  'settings.accountDescription': 'Identity and sign-in status',
  'settings.workspace': 'Workspace',
  'settings.workspaceDescription': 'Tenant and project context',
  'settings.general': 'General',
  'settings.generalDescription': 'Language and region',
  'settings.connection': 'Connection & runtime',
  'settings.connectionDescription': 'Server and local models',
  'settings.models': 'Models',
  'settings.modelsDescription': 'Providers, models, and health',
  'settings.skills': 'Skills',
  'settings.skillsDescription': 'Reusable instructions and tool boundaries',
  'settings.plugins': 'Plugins',
  'settings.pluginsDescription': 'Runtime packages, capabilities, and permissions',
  'settings.agents': 'Agents',
  'settings.agentsDescription': 'Roles, models, and capability composition',
  'settings.language': 'Language',
  'settings.languageDescription': 'Change the Desktop interface language.',
...
const zhCN: Record<string, string> = {
  ...
  'settings.aiResources': '智能体资源',
  'settings.account': '账户',
  'settings.accountDescription': '身份与登录状态',
  'settings.workspace': '工作空间',
  'settings.workspaceDescription': '租户与项目上下文',
  'settings.general': '通用',
  'settings.generalDescription': '语言与区域',
  'settings.connection': '连接与运行时',
  'settings.connectionDescription': '服务端与本地模型',
  'settings.models': '模型',
  'settings.modelsDescription': 'Provider、模型与健康状态',
  'settings.skills': '技能',
  'settings.skillsDescription': '可复用指令与工具边界',
  'settings.plugins': '插件',
  'settings.pluginsDescription': '运行时扩展包、能力与权限',
  'settings.agents': '智能体',
  'settings.agentsDescription': '角色、模型与能力组合',
  'settings.language': '语言',
  'settings.languageDescription': '更改 Desktop 的界面语言。',
  'settings.chinese': '简体中文',
  'settings.english': 'English (US)',
