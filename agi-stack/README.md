...
- 最新 P5 增量:Rust skill evolution worker queue foundation 已落地:`agistack_skill_evolution_runs` 支持 claim/complete/fail 状态推进,server 组合根接入 autostart-gated worker,完整 LLM evolution engine 仍后续;见 [04 #293](docs/architecture/04-spike-evidence.md)。此前 run admission/gateway 见 [04 #292](docs/architecture/04-spike-evidence.md)。
