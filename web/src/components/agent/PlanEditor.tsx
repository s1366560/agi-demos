        ...
        {Array.isArray(plan.metadata?.explored_files) && (
          <div>
            <Text strong style={{ fontSize: 12 }}>
              Explored Files (
              {(plan.metadata.explored_files as string[]).length}):
            </Text>
            <div style={{ marginTop: 4 }}>
              {(plan.metadata.explored_files as string[])
                .slice(0, 5)
                .map((file, i) => (
              ...
              {(plan.metadata.explored_files as string[]).length > 5 && (
                <Tag>
                  +{(plan.metadata.explored_files as string[]).length - 5} more
                </Tag>
              )}
            </div>
          </div>
