        ...
        if (!cancelled) {
          const msg =
            err instanceof Error
              ? err.message
              : t('agent.projectContext.trendingLoadFailed', {
                  defaultValue: 'Failed to load trending entities',
                });
          setError(msg);
      ...
      <div className="flex flex-wrap gap-1.5">
        {entities.map((entity, index) => (
          <button
            ...
            onClick={() =>
              onEntityClick?.(
                t('agent.projectContext.tellMeAboutEntity', {
                  defaultValue: 'Tell me about {{entityName}}',
