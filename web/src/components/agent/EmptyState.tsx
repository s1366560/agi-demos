    ...
    <div className="h-full w-full flex flex-col items-center justify-center p-6 overflow-y-auto relative">
      ...
      <div className="mt-10 text-center relative z-10">
        <p className="text-xs text-content-tertiary flex items-center justify-center gap-3 flex-wrap">
          ...
          <span className="flex items-center gap-1.5">
            <Keyboard size={12} />
            <kbd className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-slate-600 dark:text-slate-300 font-sans text-2xs">
