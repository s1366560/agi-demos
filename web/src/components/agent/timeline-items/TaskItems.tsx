...
export const TaskStartItem = memo(function TaskStartItem({ event }: TaskStartItemProps) {
...
export const TaskCompleteItem = memo(function TaskCompleteItem({ event }: TaskCompleteItemProps) {
