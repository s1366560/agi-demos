...
export const TextDeltaItem = memo(function TextDeltaItem({ event }: TextDeltaItemProps) {
...
export const TextEndItem = memo(function TextEndItem({ event }: TextEndItemProps) {
