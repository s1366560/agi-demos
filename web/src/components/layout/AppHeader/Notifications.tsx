...
export const Notifications = React.memo(function Notifications({
  ...
  return (
    <button
      onClick={onClick}
      className="relative p-1.5 sm:p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 dark:text-slate-400 transition-colors flex-shrink-0"
