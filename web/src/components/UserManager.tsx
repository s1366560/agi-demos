        ...
        return (
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-200 dark:border-slate-800 p-8">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('tenant.users.no_workspace_title')}</h3>
    ...
    if (!currentProject && context === 'project') {
        return (
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-200 dark:border-slate-800 p-8">
                <div className="text-center">
                    <Users className="h-12 w-12 text-gray-400 dark:text-slate-600 mx-auto mb-3" />
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('tenant.users.no_project_title')}</h3>
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-2">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                            {context === 'tenant' ? t('tenant.users.workspace_users') : t('tenant.users.project_users')}
                        </h3>
                        <span className="text-sm text-gray-500 dark:text-slate-500">{t('tenant.users.users_count', { count: filteredUsers.length })}</span>
                    </div>
                    <button
            ...
            <div className="p-6">
                {isLoading ? (
                    ...
                    <div className="text-center py-8">
                        <Users className="h-12 w-12 text-gray-400 dark:text-slate-600 mx-auto mb-3" />
                        <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('tenant.users.empty.title')}</h4>
