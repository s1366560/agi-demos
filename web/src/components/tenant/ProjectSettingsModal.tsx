...
export const ProjectSettingsModal: React.FC<ProjectSettingsModalProps> = ({
  ...
  return (
    <AppModal
      ...
      closeOnBackdrop={!isSaving && !isDeleting}
      footer={
        <>
          <button
            type="button"
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            disabled={isSaving}
            rows={3}
            className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div>
          <label className="flex items-center space-x-3">
            <input
              ...
              disabled={isSaving}
              className="w-4 h-4 text-primary border-gray-300 dark:border-slate-600 rounded focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
            />
            ...
            {AGENT_MODE_OPTIONS.map((option) => (
              ...
              >
                <input
                  ...
                  disabled={isSaving}
                  className="mt-0.5 w-4 h-4 text-primary border-gray-300 dark:border-slate-600 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                />
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-slate-800">
          <p className="text-xs text-gray-500 dark:text-slate-500">
            ...
            <code className="px-1 py-0.5 bg-gray-100 dark:bg-slate-800 rounded">{project.id}</code>
          </p>
