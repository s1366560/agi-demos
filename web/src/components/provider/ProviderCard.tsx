...
import { ProviderConfig, ProviderStatus, CircuitBreakerState, ProviderType } from '../../types/memory'
...
export const ProviderCard: React.FC<ProviderCardProps> = ({
    ...
    return (
        <div className="group relative bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
            ...
            <div className={`absolute top-0 left-0 right-0 h-1 ${getStatusColor(provider.health_status)}`} />
            ...
            <div className="p-5">
                ...
                <div className="flex items-start justify-between mb-4">
                    ...
                    <div className={`flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        <span className={`h-1.5 w-1.5 rounded-full ${provider.is_active ? 'bg-green-500' : 'bg-slate-400'}`} />
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    {/* Circuit Breaker */}
                    <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-xs font-medium ${getCircuitBreakerColor(circuitBreakerState)}`}>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-slate-100 dark:border-slate-700">
                    <button
                        ...
                        title="Check Health"
                    >
                        <span className={`material-symbols-outlined text-[16px] ${isCheckingHealth ? 'animate-spin' : ''}`}>
                    ...
                    {circuitBreakerState && circuitBreakerState !== 'closed' && (
                        ...
                        >
                            <span className={`material-symbols-outlined text-[16px] ${isResettingCircuitBreaker ? 'animate-spin' : ''}`}>
