...
export const RUNTIME_STATUS_STYLES: Record<
  string,
  {
    color: string;
    bgColor: string;
...
export const APP_STATUS_STYLES: Record<
  string,
  {
    color: string;
    bgColor: string;
...
export const BUTTON_STYLES = {
  primary:
    'inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary hover:bg-primary-dark text-white dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white rounded-lg transition-colors shadow-sm font-medium',
  secondary:
    'inline-flex items-center justify-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors font-medium',
  ghost:
    'inline-flex items-center justify-center gap-2 px-3 py-1.5 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors',
  danger:
    'inline-flex items-center justify-center gap-2 px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors font-medium',
};
