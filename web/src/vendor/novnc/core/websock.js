...
// Guard for environments where WebSocket may not be defined (e.g. Node.js/jsdom tests)
const WS = typeof WebSocket !== "undefined" ? WebSocket : { CONNECTING: 0, OPEN: 1, CLOSING: 2, CLOSED: 3 };

const ReadyStates = {
    CONNECTING: [WS.CONNECTING, DataChannel.CONNECTING],
    OPEN: [WS.OPEN, DataChannel.OPEN],
    CLOSING: [WS.CLOSING, DataChannel.CLOSING],
    CLOSED: [WS.CLOSED, DataChannel.CLOSED],
};
