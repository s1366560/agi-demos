...
describe('MemoryList', () => {
    ...
    it('filters memories by search term', async () => {
        vi.mocked(memoryAPI.list).mockResolvedValue({
            memories: [
                { id: 'm1', title: 'Apple Memory', content: 'About apples', processing_status: 'COMPLETED' } as Memory,
                { id: 'm2', title: 'Banana Memory', content: 'About bananas', processing_status: 'COMPLETED' } as Memory,
            ],
            total: 2,
            page: 1,
            page_size: 100,
