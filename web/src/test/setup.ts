...
const commonTranslations: Record<string, string> = {
    ...
    'tenant.projects.subtitle': 'Manage memory resources, permissions, and environments for your tenant workspace.',
    ...
    'tenant.users.subtitle': 'Manage user access, assign roles, and control permissions for this tenant.',
    ...
    'project.search.options.strategies.EDGE_HYBRID_SEARCH_CROSS_ENCODER': 'Edge Hybrid (Cross-Encoder)',
    ...
    'project.search.input.placeholder.default': 'Search memories by keyword, concept, or ask a question...',
    ...
    'project.graph.entities.detail.click_prompt': 'Click on an entity from the list to view its details and relationships',

    // Project Graph Communities
    'project.graph.communities.title': 'Communities',
    'project.graph.communities.subtitle': 'Automatically detected groups of related entities in the knowledge graph',
    ...
    'project.graph.communities.confirm_rebuild': 'This will rebuild all communities from scratch. This operation may take several minutes. The task will run in the background and you can track its progress here. Continue?',
    ...
    'project.graph.communities.empty.desc': 'Add more episodes to enable community detection, or rebuild communities',
    ...
    'project.graph.communities.info.desc': 'Communities are automatically detected groups of related entities using the Louvain algorithm. They help organize knowledge and reveal patterns in your data. Click "Rebuild Communities" to re-run the detection algorithm after adding new episodes.',
    ...
    'project.schema.overview.subtitle': 'Visual representation of the Pydantic models defining your graph structure. View entities, relationships, and their attribute definitions.',
    ...
    'login.hero.subtitle': 'Connect every knowledge point, build a growable enterprise knowledge graph. Let AI truly understand your business.',
    ...
    'project.memories.new.placeholders.content_intro': 'Capture your thoughts, ideas, and important information.',
    ...
    'project.memories.new.placeholders.content_quote': 'The best memory is one you can easily find and understand later.',
    ...
    'project.maintenance.recommendations.high_duplication.desc': 'Found {{count}} potential duplicate entities that should be merged',
