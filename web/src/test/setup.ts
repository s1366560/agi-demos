...
const commonTranslations: Record<string, string> = {
  ...
  'tenant.pluginHub.pluginsList.viewPlugin': 'View {{name}}',
  'tenant.pluginHub.pluginDetail.back': 'Plugins',
  'tenant.pluginHub.pluginDetail.subtitle':
    'Runtime manifest, capabilities, configuration schema, and raw plugin metadata',
  'tenant.pluginHub.pluginDetail.notFound': 'Plugin not found',
  'tenant.pluginHub.pluginDetail.overview': 'Overview',
  'tenant.pluginHub.pluginDetail.declaredCapabilities': 'Declared Capabilities',
  'tenant.pluginHub.pluginDetail.contracts': 'Contracts',
  'tenant.pluginHub.pluginDetail.builtinSkills': 'Built-in Skills',
  'tenant.pluginHub.pluginDetail.toolDefinitions': 'Tool Definitions',
  'tenant.pluginHub.pluginDetail.commandsAndHooks': 'Commands and Hooks',
  'tenant.pluginHub.pluginDetail.configuration': 'Configuration',
  'tenant.pluginHub.pluginDetail.metadata': 'Metadata',
  'tenant.pluginHub.pluginDetail.diagnostics': 'Diagnostics',
  'tenant.pluginHub.pluginDetail.rawRuntimeRecord': 'Raw Runtime Record',
  'tenant.pluginHub.pluginDetail.package': 'Package',
  'tenant.pluginHub.pluginDetail.version': 'Version',
  'tenant.pluginHub.pluginDetail.kind': 'Kind',
  'tenant.pluginHub.pluginDetail.manifestId': 'Manifest ID',
  'tenant.pluginHub.pluginDetail.manifestPath': 'Manifest Path',
  'tenant.pluginHub.pluginDetail.providers': 'Providers',
  'tenant.pluginHub.pluginDetail.manifestChannels': 'Manifest Channels',
  'tenant.pluginHub.pluginDetail.commandAliases': 'Command Aliases',
  'tenant.pluginHub.pluginDetail.hookMetadata': 'Hook Metadata',
  'tenant.pluginHub.pluginDetail.toolMetadata': 'Tool Metadata',
  'tenant.pluginHub.pluginDetail.activation': 'Activation',
  'tenant.pluginHub.pluginDetail.envVars': 'Environment Variables',
  'tenant.pluginHub.pluginDetail.secretPaths': 'Secret Paths',
  'tenant.pluginHub.pluginDetail.defaults': 'Defaults',
  'tenant.pluginHub.pluginDetail.configSchema': 'Config Schema',
  'tenant.pluginHub.pluginDetail.configUiHints': 'Config UI Hints',
  'tenant.pluginHub.pluginDetail.discovered': 'Discovered',
  'tenant.pluginHub.pluginDetail.notDiscovered': 'Not discovered',
  'tenant.pluginHub.pluginDetail.notDeclared': 'Not declared',
  'tenant.pluginHub.pluginDetail.notSupported': 'Not supported',
  'tenant.pluginHub.pluginDetail.none': 'None',
  'tenant.pluginHub.pluginDetail.schemaLoadFailed': 'Failed to load plugin configuration schema',
