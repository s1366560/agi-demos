...
const commonTranslations: Record<string, string> = {
  ...
  'tenant.projectManager.states.noTenantMessage':
    'Please select a workspace first',
  'tenant.projectManager.states.noTenantSubtitle':
    'Select a workspace to view and manage projects',
  'tenant.projectManager.states.noResultsMessage':
    'No matching projects found',
  'tenant.projectManager.states.noResultsSubtitle':
    'Try using different search keywords',
  'tenant.projectManager.states.noProjectsMessage':
  ...
  'skill.submit.description':
    'After submission the skill enters the admin review queue.',
  ...
  'project.settings.agentMode.singleAgent.hint': 'Each conversation routes to a single Agent; HITL appears as a private modal.',
  'project.settings.agentMode.multiShared.label': 'Multi-Agent Shared Channel',
  'project.settings.agentMode.multiShared.hint': 'Multiple Agents collaborate in the same conversation; HITL is exposed as channel messages.',
  'project.settings.agentMode.multiIsolated.label': 'Multi-Agent Isolated Threads',
  'project.settings.agentMode.multiIsolated.hint': 'Each Agent keeps an isolated thread, displayed side-by-side without interference.',
  'project.settings.projectIdPrefix': 'Project ID:',
  'project.settings.createdAtPrefix': 'Created',
  'project.settings.deleteConfirmMessage': 'Are you sure you want to delete this project? This action cannot be undone. All related memories and data will be deleted.',
  ...
  'memory.detail.versionConflict': 'Version conflict: this memory was modified by another user. Please refresh and try again.',
  ...
  'memory.manager.deleteConfirm': 'Are you sure you want to delete this memory? This action cannot be undone.',
  ...
  'admin.skillReview.pageDescription': 'Review tenant-submitted Skill candidates. Approval publishes with the current version; rejection records a review note.',
  ...
  'admin.skillReview.approveDescription': 'Approving will publish this Skill snapshot to the curated library.',
  'admin.skillReview.rejectDescription': 'Rejecting will close this record and save your review note.',
  ...
  'admin.skillReview.deprecateNote': '(If an active version already exists from the same source, the previous version will be marked deprecated automatically)',
  ...
  'skill.curated.forkDialogContent':
    'Choose what to include when copying to your private library:',
  ...
  'mcp.servers.errorBanner': '{{count}} servers have sync errors. Please check server card details.',
