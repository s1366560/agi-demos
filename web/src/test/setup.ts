...
const commonTranslations: Record<string, string> = {
  ...
  'tenant.evolution.types.learned': 'Learned',
  'tenant.evolution.types.forgot': 'Forgotten',
  'tenant.evolution.types.upgraded': 'Upgraded',
  'tenant.evolution.types.created_variant': 'Variant created',
  ...
  // Tenant trust admin
  'tenant.decisionRecords.title': 'Decision Records',
  'tenant.decisionRecords.subtitle': 'Review agent approval requests and historical decisions.',
  ...
  'tenant.decisionRecords.types.permission': 'Permission',
  'tenant.decisionRecords.types.action': 'Action',
  'tenant.decisionRecords.outcomes.pending': 'Pending',
  'tenant.decisionRecords.outcomes.approved': 'Approved',
  'tenant.decisionRecords.outcomes.denied': 'Denied',
  'tenant.decisionRecords.columns.decisionType': 'Decision Type',
  'tenant.decisionRecords.columns.agentInstance': 'Agent Instance',
  'tenant.decisionRecords.columns.outcome': 'Outcome',
  'tenant.decisionRecords.columns.context': 'Context',
  'tenant.decisionRecords.columns.createdAt': 'Created At',
  'tenant.decisionRecords.actions.resolve': 'Resolve',
  'tenant.decisionRecords.actions.details': 'Details',
  'tenant.decisionRecords.messages.resolved': 'Decision recorded successfully',
  'tenant.decisionRecords.drawer.title': 'Decision Record Details',
  'tenant.decisionRecords.drawer.recordId': 'Record ID',
  'tenant.decisionRecords.drawer.outcome': 'Outcome',
  'tenant.decisionRecords.drawer.decisionType': 'Decision Type',
  'tenant.decisionRecords.drawer.workspaceId': 'Workspace ID',
  'tenant.decisionRecords.drawer.agentInstanceId': 'Agent Instance ID',
  'tenant.decisionRecords.drawer.reviewerId': 'Reviewer ID',
  'tenant.decisionRecords.drawer.createdAt': 'Created At',
  'tenant.decisionRecords.drawer.resolvedAt': 'Resolved At',
  'tenant.decisionRecords.drawer.contextSummary': 'Context Summary',
  'tenant.decisionRecords.drawer.reviewComment': 'Review Comment',
  'tenant.decisionRecords.drawer.proposalDetails': 'Proposal Details',
  'tenant.decisionRecords.resolve.title': 'Resolve Approval Request',
  'tenant.decisionRecords.resolve.descriptionPrefix':
    'Select an action for the pending request from agent',
  'tenant.decisionRecords.resolve.descriptionSuffix': '.',
  'tenant.decisionRecords.resolve.decision': 'Decision',
  'tenant.decisionRecords.resolve.ok': 'Record Decision',
  'tenant.decisionRecords.resolve.actions.allow_once': 'Allow Once',
  'tenant.decisionRecords.resolve.actions.allow_always': 'Allow Always',
  'tenant.decisionRecords.resolve.actions.deny': 'Deny',
  'tenant.trustPolicies.title': 'Trust Policies',
  'tenant.trustPolicies.subtitle':
    'Manage automated execution permissions for agents in your workspaces.',
  'tenant.trustPolicies.refresh': 'Refresh trust policies',
  'tenant.trustPolicies.empty': 'No trust policies found',
  'tenant.trustPolicies.loadError': 'Failed to load trust policies',
  'tenant.trustPolicies.actions.createPolicy': 'Create Policy',
  'tenant.trustPolicies.actions.viewDetails': 'View Details',
  'tenant.trustPolicies.messages.created': 'Trust policy created successfully',
  'tenant.trustPolicies.filters.workspaceId': 'Filter by Workspace ID',
  'tenant.trustPolicies.filters.agentInstanceId': 'Filter by Agent Instance ID',
  'tenant.trustPolicies.columns.actionType': 'Action Type',
  'tenant.trustPolicies.columns.agentInstance': 'Agent Instance',
  'tenant.trustPolicies.columns.grantType': 'Grant Type',
  'tenant.trustPolicies.columns.grantedBy': 'Granted By',
  'tenant.trustPolicies.columns.createdAt': 'Created At',
  'tenant.trustPolicies.grantTypes.once': 'Once',
  'tenant.trustPolicies.grantTypes.always': 'Always',
  'tenant.trustPolicies.details.title': 'Policy Details',
  'tenant.trustPolicies.details.policyId': 'Policy ID',
  'tenant.trustPolicies.details.createdAt': 'Created At',
  'tenant.trustPolicies.details.actionType': 'Action Type',
  'tenant.trustPolicies.details.grantType': 'Grant Type',
  'tenant.trustPolicies.details.workspaceId': 'Workspace ID',
  'tenant.trustPolicies.details.agentInstanceId': 'Agent Instance ID',
  'tenant.trustPolicies.details.grantedBy': 'Granted By',
  'tenant.trustPolicies.details.deletedAt': 'Deleted At',
  'tenant.trustPolicies.create.title': 'Create Trust Policy',
  'tenant.trustPolicies.create.workspaceId': 'Workspace ID',
  'tenant.trustPolicies.create.workspaceIdRequired': 'Workspace ID is required',
  'tenant.trustPolicies.create.workspaceIdPlaceholder': 'workspace-id',
  'tenant.trustPolicies.create.agentInstanceId': 'Agent Instance ID',
  'tenant.trustPolicies.create.agentInstanceIdRequired': 'Agent instance ID is required',
  'tenant.trustPolicies.create.agentInstanceIdPlaceholder': 'agent-instance-id',
  'tenant.trustPolicies.create.actionType': 'Action Type',
  'tenant.trustPolicies.create.actionTypeRequired': 'Action type is required',
  'tenant.trustPolicies.create.actionTypeTooltip': 'Tool or action permission key',
  'tenant.trustPolicies.create.actionTypePlaceholder': 'terminal.execute',
  'tenant.trustPolicies.create.grantType': 'Grant Type',
  'tenant.trustPolicies.create.grantTypeRequired': 'Grant type is required',
  ...
  'tenant.projects.pagination.summary': '{{start}}-{{end}} of {{total}} projects',
  'tenant.projects.pagination.rowsPerPage': 'Rows',
  'tenant.projects.pagination.previousPage': 'Previous page',
  'tenant.projects.pagination.nextPage': 'Next page',
  ...
  'tenant.skills.createWithChat': 'Create in chat',
  ...
  'tenant.skills.registry': 'Skill Registry',
  'tenant.skills.libraryViewLabel': 'Skill library view',
  ...
  'tenant.skills.source.database': 'Database',
  'tenant.skills.source.filesystem': 'Filesystem',
  'tenant.skills.source.hybrid': 'Hybrid',
  'tenant.skills.source.plugin': 'Plugin',
  'tenant.skills.card.tools': 'Tools',
  'tenant.skills.actions.viewShort': 'Preview',
  'tenant.skills.actions.view': 'View details',
  'tenant.skills.actions.viewAria': 'View skill details',
  'tenant.skills.actions.edit': 'Edit',
  'tenant.skills.actions.editAria': 'Edit skill',
  'tenant.skills.actions.export': 'Export',
  'tenant.skills.actions.exportAria': 'Export skill package',
  'tenant.skills.actions.versions': 'Versions',
  'tenant.skills.actions.versionsAria': 'Manage skill versions',
  'tenant.skills.actions.more': 'More actions',
  'tenant.skills.actions.delete': 'Delete',
  'tenant.skills.actions.deleteAria': 'Delete skill',
  'tenant.skills.systemConfig.disable': 'Tenant disabled',
  'tenant.skills.systemConfig.override': 'Tenant override',
  'tenant.skills.systemConfig.disableAction': 'Disable for tenant',
  'tenant.skills.systemConfig.disableAria': 'Disable {{name}} for this tenant',
  'tenant.skills.systemConfig.disableConfirm': 'Disable this system skill for the current tenant?',
  'tenant.skills.systemConfig.disableSuccess': 'System skill disabled for this tenant',
  'tenant.skills.systemConfig.disableFailed': 'Failed to disable system skill',
  'tenant.skills.systemConfig.restoreAction': 'Restore system default',
  'tenant.skills.systemConfig.restoreAria': 'Restore {{name}} system default for this tenant',
  'tenant.skills.systemConfig.restoreConfirm':
  ...
  'tenant.skills.modal.specPanelTitle': 'AgentSkills.io package',
  'tenant.skills.modal.specPanelDescription':
    'Define the required frontmatter, write the Markdown instructions, and review the generated SKILL.md before saving.',
  'tenant.skills.modal.frontmatter': 'Frontmatter',
  ...
  'tenant.skills.modal.nameRequired': 'Please enter skill name',
  'tenant.skills.modal.namePattern': 'Use lowercase letters, numbers, and single hyphens only',
  'tenant.skills.modal.nameMax': 'Skill name must be 64 characters or fewer',
  'tenant.skills.modal.description': 'Description',
  'tenant.skills.modal.descriptionRequired': 'Please enter skill description',
  'tenant.skills.modal.descriptionMax': 'Description must be 1024 characters or fewer',
  'tenant.skills.modal.descriptionPlaceholder': 'Describe what this skill does...',
  'tenant.skills.modal.scope': 'Scope',
  'tenant.skills.modal.scopeRequired': 'Please select a scope',
  'tenant.skills.modal.scopeTenant': 'Tenant',
  'tenant.skills.modal.scopeProject': 'Project',
  'tenant.skills.modal.projectId': 'Project ID',
  'tenant.skills.modal.projectIdRequired': 'Project ID is required for project scope',
  'tenant.skills.modal.projectIdPlaceholder': 'Project UUID',
  'tenant.skills.modal.allowedTools': 'Allowed Tools',
  'tenant.skills.modal.allowedToolsRaw': 'allowed-tools',
  'tenant.skills.modal.allowedToolsRawPlaceholder': 'Bash(git:*) Bash(jq:*) Read',
  'tenant.skills.modal.body': 'Markdown instructions',
  'tenant.skills.modal.bodyPlaceholder':
    'Write the instructions agents should follow when this skill activates...',
  'tenant.skills.modal.advanced': 'Optional frontmatter',
  'tenant.skills.modal.advancedHint': 'License, compatibility, spec version, and metadata.',
  'tenant.skills.modal.preview': 'Generated package',
  'tenant.skills.modal.previewEmpty': 'Enter a name and description to preview SKILL.md.',
  'tenant.skills.modal.previewInvalid': 'Fix invalid metadata to preview SKILL.md.',
  'tenant.skills.modal.noTools': 'No tools yet, please add at least one',
  'tenant.skills.modal.toolsHint':
    'Optional. Leave blank to omit allowed-tools from frontmatter; the runtime stores this as unrestricted internally.',
  'tenant.skills.detail.back': 'Back to skills',
  'tenant.skills.detail.loadFailed': 'Failed to load skill',
  'tenant.skills.detail.versionLoadFailed': 'Failed to load skill versions',
  'tenant.skills.detail.refresh': 'Refresh',
  'tenant.skills.detail.edit': 'Edit',
  'tenant.skills.detail.export': 'Export',
  'tenant.skills.detail.viewMode': 'Skill detail view',
  'tenant.skills.detail.viewModes.preview': 'Preview',
  'tenant.skills.detail.viewModes.manage': 'Manage',
  'tenant.skills.detail.viewModes.report': 'Assessment',
  'tenant.skills.detail.assessment.title': 'Assessment report',
  'tenant.skills.detail.assessment.description': 'Static assessment summary.',
  'tenant.skills.detail.assessment.copy': 'Copy report',
  'tenant.skills.detail.assessment.copySuccess': 'Assessment report copied',
  'tenant.skills.detail.assessment.copyFailed': 'Failed to copy assessment report',
  'tenant.skills.detail.assessment.details': 'Assessment details',
  'tenant.skills.detail.assessment.groupPassed': 'Passed checks',
  'tenant.skills.detail.assessment.generatedAt': 'Generated from the {{date}} skill snapshot',
  'tenant.skills.detail.assessment.staticNotice':
    'This report is a local static check. It does not run an external sandbox security scan or live quality evaluation.',
  'tenant.skills.detail.assessment.reportTitle': 'Skill assessment report',
  'tenant.skills.detail.assessment.reportSkill': 'Skill',
  'tenant.skills.detail.assessment.reportGeneratedAt': 'Generated at',
  'tenant.skills.detail.assessment.reportStatus': 'Status',
  'tenant.skills.detail.assessment.status.safe': 'No high-risk findings',
  'tenant.skills.detail.assessment.status.attention': 'Needs attention',
  'tenant.skills.detail.assessment.itemStatus.pass': 'Pass',
  'tenant.skills.detail.assessment.itemStatus.warn': 'Review',
  'tenant.skills.detail.assessment.groups.p0': 'P0 required',
  'tenant.skills.detail.assessment.groups.p1': 'P1 important',
  'tenant.skills.detail.assessment.groups.p2': 'P2 recommended',
  'tenant.skills.detail.assessment.items.secrets.title': 'Hardcoded credentials',
  'tenant.skills.detail.assessment.items.secrets.pass':
    'No obvious key, token, or password literals were found in the skill files.',
  'tenant.skills.detail.assessment.items.secrets.warn':
    'Possible key, token, or password literals were detected. Remove them before release.',
  'tenant.skills.detail.assessment.items.hiddenCharacters.title': 'Hidden characters',
  'tenant.skills.detail.assessment.items.hiddenCharacters.pass':
    'No zero-width characters or BOM markers were found.',
  'tenant.skills.detail.assessment.items.hiddenCharacters.warn':
    'Hidden characters were detected. Check for invisible instructions or formatting issues.',
  'tenant.skills.detail.assessment.items.allowedTools.title': 'Tool permissions',
  'tenant.skills.detail.assessment.items.allowedTools.pass':
    'The skill declares available tools, so the permission boundary is reviewable.',
  'tenant.skills.detail.assessment.items.allowedTools.warn':
    'The skill does not declare tool permissions. Add allowed-tools or confirm runtime policy.',
  'tenant.skills.detail.assessment.items.packageFiles.title': 'Package integrity',
  'tenant.skills.detail.assessment.items.packageFiles.pass':
    '{{count}} skill package files are available for preview.',
  'tenant.skills.detail.assessment.items.metadata.title': 'Metadata',
  'tenant.skills.detail.assessment.items.metadata.pass': 'The skill includes structured metadata.',
  'tenant.skills.detail.assessment.items.metadata.warn':
    'The skill has no metadata, leaving less context for search, categorization, or governance.',
  'tenant.skills.detail.assessment.items.versioning.title': 'Version history',
  'tenant.skills.detail.assessment.items.versioning.pass':
    'The skill has a current version or saved version snapshots.',
  'tenant.skills.detail.assessment.items.versioning.warn':
    'No rollback-friendly version snapshot was found.',
  'tenant.skills.detail.assessment.items.documentation.title': 'Supplementary docs',
  'tenant.skills.detail.assessment.items.documentation.pass':
    'The package includes files beyond SKILL.md.',
  'tenant.skills.detail.assessment.items.documentation.warn':
    'The package only includes SKILL.md. Complex skills should add examples or schemas.',
  'tenant.skills.detail.assessment.items.licenseCompatibility.title': 'License and compatibility',
  'tenant.skills.detail.assessment.items.licenseCompatibility.pass':
    'License and compatibility notes are filled in.',
  'tenant.skills.detail.assessment.items.licenseCompatibility.warn':
    'License or compatibility notes are incomplete. Add runtime constraints where relevant.',
  'tenant.skills.detail.package': 'Package',
  'tenant.skills.detail.allowedToolsRaw': 'Allowed tools',
  'tenant.skills.detail.license': 'License',
  'tenant.skills.detail.compatibility': 'Compatibility',
  'tenant.skills.detail.specVersion': 'Spec',
  'tenant.skills.detail.files': 'File preview',
  'tenant.skills.detail.packageFiles': '{{count}} files',
  'tenant.skills.detail.fileKinds.markdown': 'Markdown',
  'tenant.skills.detail.fileKinds.text': 'Text',
  'tenant.skills.detail.contentMode': 'SKILL.md display mode',
  'tenant.skills.detail.contentModes.preview': 'Preview',
  'tenant.skills.detail.contentModes.raw': 'Source',
  'tenant.skills.detail.emptyContent': 'No SKILL.md content saved',
  'tenant.skills.detail.identity': 'Identity',
  'tenant.skills.detail.id': 'ID',
  'tenant.skills.detail.source': 'Source',
  'tenant.skills.detail.filePath': 'File path',
  'tenant.skills.detail.scope': 'Scope',
  'tenant.skills.detail.scopeValues.tenant': 'Tenant',
  'tenant.skills.detail.scopeValues.project': 'Project',
  'tenant.skills.detail.scopeValues.system': 'System',
  'tenant.skills.detail.project': 'Project',
  'tenant.skills.detail.created': 'Created',
  'tenant.skills.detail.updated': 'Updated',
  'tenant.skills.detail.versions': 'Versions',
  'tenant.skills.detail.emptyVersions': 'No version snapshots yet',
  'tenant.skills.detail.notVersioned':
    'Filesystem skills are read-only and do not have database version snapshots',
  'tenant.skills.detail.notSet': 'Not set',
  'tenant.skills.detail.metadata': 'Metadata',
  'tenant.skills.detail.evolutionRoute': 'Evolution route',
  'tenant.skills.detail.runEvolution': 'Run evolution',
  'tenant.skills.detail.evolutionRunning': 'Running',
  'tenant.skills.detail.emptyEvolutionRoute': 'No evolution jobs or version route yet',
  'tenant.skills.modal.metadataJson': 'Metadata JSON',
  'tenant.skills.modal.metadataInvalid': 'Metadata must be a JSON object',
  'tenant.skills.modal.specVersion': 'Spec version',
  'tenant.skills.modal.license': 'License',
  'tenant.skills.modal.licensePlaceholder': 'Apache-2.0',
  'tenant.skills.modal.compatibility': 'Compatibility',
  'tenant.skills.modal.compatibilityMax': 'Compatibility must be 500 characters or fewer',
  'tenant.skills.modal.compatibilityPlaceholder':
    'Required product, system packages, network access, or runtime notes',
  ...
  'nav.agentBuilding': 'Agent Building',
  'nav.extensionsIntegrations': 'Extensions & Integrations',
  'nav.runtimeInfrastructure': 'Runtime & Infrastructure',
  'nav.governanceManagement': 'Governance & Management',
