...
describe('EntityCard', () => {
    ...
    it('renders entity summary when provided', () => {
        ...
        expect(screen.getByText('This is a test entity summary that describes the entity in detail.')).toBeInTheDocument()
    })
    ...
    it('does not render summary element when not provided', () => {
        ...
        const { container } = render(<EntityCard entity={entityWithoutSummary} onClick={mockOnClick} />)
