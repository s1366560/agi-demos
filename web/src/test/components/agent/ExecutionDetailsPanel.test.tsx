...
vi.mock('../../../components/agent/execution/ToolCallVisualization', () => ({
  ToolCallVisualization: () => <div data-testid="tool-visualization">Tool Visualization</div>,
}));
...
vi.mock('../../../utils/agentDataAdapters', () => ({
  ...
  adaptToolVisualizationData: () => [{ id: 'tool-1', name: 'search', status: 'success' }],
  extractTokenData: () => ({
...
describe('ExecutionDetailsPanel Compound Component', () => {
  ...
  describe('Backward Compatibility', () => {
    ...
    it('should support defaultView prop', () => {
      render(<ExecutionDetailsPanel message={mockMessage} defaultView="activity" />);
