...
describe('AgentProgressBar', () => {
  ...
  describe('Progress Bar Visual', () => {
    ...
    it('should show status class on progress bar', () => {
      const { container } = render(<AgentProgressBar current={1} total={3} status="step_executing" />)
  ...
  describe('Compact Mode', () => {
    ...
    it('should hide step dots in compact mode', () => {
      render(<AgentProgressBar current={1} total={3} status="step_executing" showSteps={true} compact={true} />)
  ...
  describe('Labels', () => {
    it('should show custom label when provided', () => {
      render(<AgentProgressBar current={1} total={3} status="step_executing" label="Searching memories..." />)
    ...
    it('should show estimated time remaining when provided', () => {
      render(<AgentProgressBar current={1} total={3} status="step_executing" estimatedTimeRemaining="~30s" />)
  ...
  describe('Accessibility', () => {
    ...
    it('should announce status changes', () => {
      const { rerender } = render(<AgentProgressBar current={1} total={3} status="step_executing" />)
  ...
  describe('Animation', () => {
    it('should show animate class when animate is true', () => {
      const { container } = render(<AgentProgressBar current={1} total={3} status="step_executing" animate={true} />)
    ...
    it('should not show animate class when animate is false', () => {
      const { container } = render(<AgentProgressBar current={1} total={3} status="step_executing" animate={false} />)
