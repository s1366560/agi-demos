...
describe('DecisionModal (Compound Components)', () => {
  describe('DecisionModal - Main Container', () => {
    it('should render modal with correct title and type', async () => {
      ...
      render(<DecisionModal data={mockDecisionData} onRespond={onRespond} onCancel={onCancel} />);
  ...
  describe('DecisionModal.Header', () => {
    ...
    it('should not render context when context is empty', async () => {
      ...
      render(<DecisionModal data={dataWithoutContext} onRespond={onRespond} onCancel={onCancel} />);
  ...
  describe('DecisionModal.Option', () => {
    ...
    it('should not render risk alert when no risks', async () => {
      ...
      render(<DecisionModal data={dataWithoutRisks} onRespond={onRespond} onCancel={onCancel} />);
  ...
  describe('DecisionModal.CustomInput', () => {
    ...
    it('should not render custom input when allow_custom is false', async () => {
      ...
      render(<DecisionModal data={dataWithoutCustom} onRespond={onRespond} onCancel={onCancel} />);
  ...
  describe('DecisionModal.Footer', () => {
    ...
    it('should disable submit button when no option selected', async () => {
      ...
      const dataWithoutDefault = {
        ...
        options: [
          ...mockDecisionData.options.map((opt) => ({
            ...opt,
      ...
      render(<DecisionModal data={dataWithoutDefault} onRespond={onRespond} onCancel={onCancel} />);
  ...
  describe('Decision Types', () => {
    it('should display correct label for method type', async () => {
      ...
      render(<DecisionModal data={methodData} onRespond={vi.fn()} onCancel={vi.fn()} />);
    ...
    it('should display correct label for confirmation type', async () => {
      ...
      render(<DecisionModal data={confirmationData} onRespond={vi.fn()} onCancel={vi.fn()} />);
    ...
    it('should display correct label for risk type', async () => {
      ...
      render(<DecisionModal data={riskData} onRespond={vi.fn()} onCancel={vi.fn()} />);
    ...
    it('should display correct label for custom type', async () => {
      ...
      render(<DecisionModal data={customTypeData} onRespond={vi.fn()} onCancel={vi.fn()} />);
  ...
  describe('Edge Cases', () => {
    it('should handle empty options array', async () => {
      ...
      render(<DecisionModal data={emptyOptionsData} onRespond={vi.fn()} onCancel={vi.fn()} />);
    ...
    it('should handle null context', async () => {
      ...
      render(<DecisionModal data={nullContextData} onRespond={vi.fn()} onCancel={vi.fn()} />);
    ...
    it('should handle undefined default_option', async () => {
      ...
      render(<DecisionModal data={noDefaultData} onRespond={vi.fn()} onCancel={vi.fn()} />);
