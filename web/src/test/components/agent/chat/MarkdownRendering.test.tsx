...
| Organization | Company |
    ...
    render(
      <ToolExecutionCardDisplay toolName="GraphQuery" status="success" result={tableResult} />
    );
...
\`\`\`
    ...
    render(<ToolExecutionCardDisplay toolName="GraphQuery" status="success" result={codeResult} />);
