...
const createMockProjectStore = () => ({
  ...
  getProject: vi.fn(() => Promise.resolve({ id: 'proj-1', name: 'Test Project', tenant_id: 'tenant-1' })),
})
...
const createMockAgentStore = () => ({
  ...
  createConversation: vi.fn(() => Promise.resolve({ id: 'conv-1', title: 'New Conversation', project_id: 'proj-1', status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString() })),
