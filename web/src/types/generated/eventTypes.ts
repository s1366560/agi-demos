...
export const DELTA_EVENT_TYPES: AgentEventType[] = ["text_start", "thought_delta", "text_end", "text_delta"];
...
export const HITL_EVENT_TYPES: AgentEventType[] = ["decision_asked", "clarification_asked", "env_var_requested", "permission_asked"];
