...
export const DELTA_EVENT_TYPES: AgentEventType[] = ["text_end", "thought_delta", "text_delta", "act_delta", "text_start"];
...
export const HITL_EVENT_TYPES: AgentEventType[] = ["env_var_requested", "elicitation_asked", "permission_asked", "decision_asked", "clarification_asked"];
