...
export const DELTA_EVENT_TYPES: AgentEventType[] = ["text_end", "act_delta", "text_delta", "text_start", "thought_delta"];
...
export const HITL_EVENT_TYPES: AgentEventType[] = ["clarification_asked", "decision_asked", "permission_asked", "env_var_requested", "elicitation_asked", "a2ui_action_asked"];
