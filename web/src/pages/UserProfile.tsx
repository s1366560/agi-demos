    ...
    return (
        <div className="mx-auto w-full max-w-7xl p-6 lg:p-8">
            ...
            <div className="mb-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{t('user_profile.title')}</h1>
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-24 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-surface-dark">
                        ...
                        <div className="relative flex flex-col items-center px-6 pb-8">
                            ...
                            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">{formData.profile?.job_title || t('user_profile.no_job_title')}</p>
                            <div className="mt-4 flex w-full flex-col gap-2 border-t border-slate-200 py-4 dark:border-slate-700">
                                ...
                                <div className="flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400">
                                    ...
                                    <span>{t('user_profile.member_since', { date: new Date(user.created_at).toLocaleDateString() })}</span>
                                </div>
                            </div>
                            <div className="mt-2 w-full">
                                <div className="mb-2 flex items-center justify-between text-xs">
                                    <span className="text-slate-500 dark:text-slate-400">{t('user_profile.profile_completion')}</span>
                    ...
                    <div className="rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-surface-dark">
                        ...
                        <div className="border-b border-slate-200 px-6 dark:border-slate-700">
                            <nav aria-label="Tabs" className="-mb-px flex space-x-8">
                                <button aria-current="page" className="border-b-2 border-primary px-1 py-4 text-sm font-medium text-primary dark:text-white">{t('user_profile.tabs.basic')}</button>
                                <button className="border-b-2 border-transparent px-1 py-4 text-sm font-medium text-slate-500 hover:border-gray-300 hover:text-slate-700 dark:text-slate-400 dark:hover:border-gray-600 dark:hover:text-white">{t('user_profile.tabs.contact')}</button>
                                <button className="border-b-2 border-transparent px-1 py-4 text-sm font-medium text-slate-500 hover:border-gray-300 hover:text-slate-700 dark:text-slate-400 dark:hover:border-gray-600 dark:hover:text-white">{t('user_profile.tabs.preferences')}</button>
                                <button className="border-b-2 border-transparent px-1 py-4 text-sm font-medium text-slate-500 hover:border-gray-300 hover:text-slate-700 dark:text-slate-400 dark:hover:border-gray-600 dark:hover:text-white">{t('user_profile.tabs.security')}</button>
                            </nav>
                        </div>
                        <div className="p-6">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-8">
                                    <h3 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">{t('user_profile.basic.title')}</h3>
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="email">{t('user_profile.basic.email')}</label>
                                            <div className="mt-2">
                                        ...
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="name">{t('user_profile.basic.full_name')}</label>
                                            <div className="mt-2">
                                                <input
                                        ...
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="job_title">{t('user_profile.basic.job_title')}</label>
                                            <div className="mt-2">
                                                <input
                                                    className="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary dark:bg-background-dark dark:ring-gray-700 dark:text-white sm:text-sm sm:leading-6"
                                                    id="job_title"
                                        ...
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="department">{t('user_profile.basic.department')}</label>
                                            <div className="mt-2">
                                                <select
                                        ...
                                        <div className="col-span-full">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="bio">{t('user_profile.basic.about')}</label>
                                            <div className="mt-2">
                                                <textarea
                                                    className="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary dark:bg-background-dark dark:ring-gray-700 dark:text-white sm:text-sm sm:leading-6"
                                                    id="bio"
                                            ...
                                            <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">{t('user_profile.basic.about_hint')}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8">
                                    <h3 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">{t('user_profile.contact.title')}</h3>
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="phone">{t('user_profile.contact.phone')}</label>
                                            <div className="mt-2">
                                                <input
                                                    className="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary dark:bg-background-dark dark:ring-gray-700 dark:text-white sm:text-sm sm:leading-6"
                                                    id="phone"
                                        ...
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="location">{t('user_profile.contact.location')}</label>
                                            <div className="mt-2">
                                ...
                                {/* Preferences Section */}
                                <div className="mb-8">
                                    <h3 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">{t('user_profile.preferences.title')}</h3>
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="language">{t('user_profile.preferences.language')}</label>
                                            <div className="mt-2">
                                                <select
                                                    className="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary dark:bg-background-dark dark:ring-gray-700 dark:text-white sm:text-sm sm:leading-6"
                                                    id="language"
                                        ...
                                        <div className="sm:col-span-3">
                                            <label className="block text-sm font-medium leading-6 text-slate-900 dark:text-white" htmlFor="timezone">{t('user_profile.preferences.timezone')}</label>
                                            <div className="mt-2">
                                                <select
                                                    className="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary dark:bg-background-dark dark:ring-gray-700 dark:text-white sm:text-sm sm:leading-6"
                                                    id="timezone"
                                ...
                                <div className="flex items-center justify-end gap-x-4 border-t border-slate-200 pt-6 dark:border-slate-700">
                                    <button className="rounded-md px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:ring-gray-600 dark:text-white dark:hover:bg-gray-800" type="button">{t('user_profile.buttons.cancel')}</button>
                                    <button
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        <p className="text-sm font-medium text-slate-900 dark:text-white">{t('user_profile.toast.success_title')}</p>
                                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">{t('user_profile.toast.success_desc')}</p>
                                    </div>
