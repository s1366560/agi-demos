        ...
        <div className="max-w-full mx-auto flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="relative overflow-hidden rounded-xl p-6 shadow-lg bg-gradient-to-br from-[#1e3fae] to-[#3b82f6] text-white group hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                        ...
                        <div>
                            <p className="text-blue-100 text-sm font-medium mb-1">{t('tenant.overview.totalStorage')}</p>
                ...
                <div className="relative overflow-hidden rounded-xl p-6 shadow-lg bg-gradient-to-br from-indigo-600 to-violet-500 text-white group hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                        <div className="flex items-start justify-between">
                            ...
                            <span className="text-xs font-medium bg-white/20 px-2 py-1 rounded text-white backdrop-blur-sm">{stats.projects.active} {t('common.status.active')}</span>
                        </div>
                        <div>
                            <p className="text-indigo-100 text-sm font-medium mb-1">{t('tenant.overview.activeProjects')}</p>
                            <h3 className="text-3xl font-bold tracking-tight">{stats.projects.active}</h3>
                        </div>
                        <p className="text-indigo-100 text-sm">{t('tenant.overview.newProjectThisWeek', { count: stats.projects.new_this_week })}</p>
                    </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-xl p-6 shadow-lg bg-gradient-to-br from-slate-700 to-slate-600 text-white group hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                        <div className="flex items-start justify-between">
                            ...
                            <span className="text-xs font-medium bg-white/20 px-2 py-1 rounded text-white backdrop-blur-sm">{t('common.stats.total')} {stats.members.total}</span>
                        </div>
                        <div>
                            <p className="text-slate-200 text-sm font-medium mb-1">{t('tenant.overview.teamMembers')}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 flex flex-col">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('tenant.overview.memoryUsageHistory')}</h3>
                ...
                <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">{t('tenant.overview.tenantInfo')}</h3>
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">{t('tenant.overview.orgId')}</p>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">{t('tenant.overview.currentPlan')}</p>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">{t('tenant.overview.region')}</p>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4 border border-slate-100 dark:border-slate-800">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-sm text-slate-500">{t('tenant.overview.nextBillingDate')}</span>
            ...
            <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden">
                <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex flex-wrap gap-4 items-center justify-between">
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('tenant.overview.mostActiveProjects')}</h3>
                    <Link to="/tenant/projects" className="text-primary text-sm font-medium hover:underline">{t('common.actions.viewAll')}</Link>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
                                ...
                                <th className="py-4 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">{t('common.stats.owner')}</th>
