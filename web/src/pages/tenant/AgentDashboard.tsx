        ...
        <div className="max-w-7xl mx-auto pb-24">
            <header className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-xl font-black tracking-tight uppercase text-slate-900 dark:text-white">SubAgent Platform</h1>
                </div>
                <div className="max-w-2xl">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Configure Your Intelligence Core</h2>
                    <p className="text-slate-500 dark:text-slate-400">Activate your first SubAgents and define the foundational skills for your enterprise tenant.</p>
                </div>
            </header>
                ...
                <div className="col-span-12 lg:col-span-8 space-y-8">
                    ...
                    <section>
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400">Available SubAgents</h3>
                            <span className="text-xs text-slate-500">{subAgents.filter(a => a.active).length} selected</span>
                        </div>
                ...
                <div className="col-span-12 lg:col-span-4">
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden sticky top-6">
                        <div className="p-5 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between bg-slate-50 dark:bg-slate-900/50">
                            <h3 className="font-bold text-sm uppercase tracking-wide text-slate-700 dark:text-slate-200">Standard Skill Registry</h3>
