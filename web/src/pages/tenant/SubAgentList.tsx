...
export const SubAgentList: React.FC = () => {
  ...
  }, []); // Run only once on mount - store functions are stable
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [search, statusFilter]); // Only depend on filter values, not setFilters
    ...
    <div className="max-w-[1400px] mx-auto w-full flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              {t("tenant.subagents.stats.total")}
            </p>
        ...
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              {t("tenant.subagents.stats.enabled")}
            </p>
        ...
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              {t("tenant.subagents.stats.successRate")}
            </p>
        ...
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              {t("tenant.subagents.stats.invocations")}
            </p>
...
interface SubAgentCardProps {
  ...
  StatusBadge: React.FC<{ enabled: boolean }>;
}
      ...
      <div className="p-4 border-b border-slate-100 dark:border-slate-700">
        <div className="flex items-start justify-between">
          ...
          <Switch
            ...
            onChange={(checked) => onToggle(subagent.id, checked)}
            size="small"
          />
        </div>
      </div>
      ...
      <div className="px-4 py-3 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Popconfirm
            ...
            onConfirm={() => onDelete(subagent.id)}
