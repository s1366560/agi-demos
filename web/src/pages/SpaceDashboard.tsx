...
export const SpaceDashboard: React.FC = () => {
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[
        t('space.dashboard.breadcrumbs.home'),
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-1">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">
              {t('space.dashboard.welcome.title')}
            </h2>
            <p className="text-gray-500 dark:text-slate-400">
              {t('space.dashboard.welcome.subtitle')}
            </p>
          </div>
              ...
              <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                ...
                <div>
                  <p className="text-blue-100 text-sm font-medium mb-1">
                    {t('space.dashboard.stats.storage.title')}
                  </p>
                  <div className="flex items-baseline gap-2">
                    <h3 className="text-3xl font-bold tracking-tight">
                      {(stats.storage.used / (1024 * 1024 * 1024 * 1024)).toFixed(1)} TB
                    </h3>
                    <span className="text-blue-200 text-sm">
                      / {(stats.storage.total / (1024 * 1024 * 1024 * 1024)).toFixed(0)} TB
                    </span>
                  </div>
                </div>
              ...
              <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                ...
                <div>
                  <p className="text-indigo-100 text-sm font-medium mb-1">
                    {t('space.dashboard.stats.projects.title')}
                  </p>
                  <h3 className="text-3xl font-bold tracking-tight">{stats.projects.active}</h3>
                </div>
                <p className="text-indigo-100 text-sm">
                  {t('space.dashboard.stats.projects.new_this_week', {
                    count: stats.projects.new_this_week,
                  })}
                </p>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl p-6 shadow-lg bg-gradient-to-br from-slate-700 to-slate-600 text-white group hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="relative z-10 flex flex-col justify-between h-full gap-4">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-xs font-medium bg-white/20 px-2 py-1 rounded text-white backdrop-blur-sm">
                    {t('space.dashboard.stats.members.total_badge', { count: stats.members.total })}
                  </span>
                </div>
                <div>
                  <p className="text-slate-200 text-sm font-medium mb-1">
                    {t('space.dashboard.stats.members.title')}
                  </p>
                ...
                <div className="flex -space-x-2 overflow-hidden mt-1">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="inline-block h-6 w-6 rounded-full ring-2 ring-slate-600 bg-gray-400 flex items-center justify-center text-xs font-medium text-white"
                    >
                      U{i}
                    </div>
                  ))}
                  <div className="h-6 w-6 rounded-full bg-slate-500 ring-2 ring-slate-600 flex items-center justify-center text-[10px] font-medium text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6 flex flex-col">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">
                    {t('space.dashboard.charts.memory_usage.title')}
                  </h3>
                  <p className="text-sm text-gray-500 dark:text-slate-400">
                    {t('space.dashboard.charts.memory_usage.subtitle')}
                  </p>
                </div>
              ...
              <div className="flex-1 w-full min-h-[240px] relative">
                ...
                >
                  ...
                  <path
                    d={generatePath(stats.memory_history, 800, 300)}
                    fill="url(#chartGradient)"
                  ></path>
                  <path
                    d={generateLinePath(stats.memory_history, 800, 300)}
                    fill="none"
                    stroke="#1e3fae"
                    strokeWidth="2"
            ...
            <div className="bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">
                {t('space.dashboard.tenant_info.title')}
              </h3>
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-400 dark:text-slate-500 uppercase tracking-wider">
                      {t('space.dashboard.tenant_info.org_id')}
                    </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-400 dark:text-slate-500 uppercase tracking-wider">
                      {t('space.dashboard.tenant_info.plan')}
                    </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-400 dark:text-slate-500 uppercase tracking-wider">
                      {t('space.dashboard.tenant_info.region')}
                    </p>
                ...
                <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4 border border-gray-100 dark:border-slate-700">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-gray-500 dark:text-slate-400">
                      {t('space.dashboard.tenant_info.next_billing')}
                    </span>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 flex flex-col overflow-hidden">
            <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex flex-wrap gap-4 items-center justify-between">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">
                {t('space.dashboard.active_projects.title')}
              </h3>
              <button
                onClick={() => setActiveTab('projects')}
                className="text-blue-600 dark:text-blue-400 text-sm font-medium hover:underline"
              >
                {t('space.dashboard.active_projects.view_all')}
              </button>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50 dark:bg-slate-800 border-b border-gray-100 dark:border-slate-800">
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                      {t('space.dashboard.active_projects.table.name')}
                    </th>
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                      {t('space.dashboard.active_projects.table.owner')}
                    </th>
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                      {t('space.dashboard.active_projects.table.memory')}
                    </th>
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider text-right">
                      {t('space.dashboard.active_projects.table.status')}
                    </th>
                    <th className="py-4 px-6 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider text-right">
                      {t('space.dashboard.active_projects.table.actions')}
                    </th>
                  </tr>
                </thead>
                    ...
                    >
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          <div
                            className={`p-2 rounded-lg ${index % 3 === 0 ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : index % 3 === 1 ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' : 'bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400'}`}
                          >
                            {index % 3 === 0 ? (
                      ...
                      <td className="py-4 px-6 text-right">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium ${project.status === 'Active' ? 'bg-emerald-100 dark:bg-emerald-900/20 text-emerald-800 dark:text-emerald-400' : 'bg-amber-100 dark:bg-amber-900/20 text-amber-800 dark:text-amber-400'}`}
                        >
                          <span
                            className={`h-1.5 w-1.5 rounded-full ${project.status === 'Active' ? 'bg-emerald-500' : 'bg-amber-500'}`}
                          ></span>
                          {project.status}
                        </span>
                      </td>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                {t('space.dashboard.projects_tab.title')}
              </h2>
              <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">
                {t('space.dashboard.projects_tab.subtitle')}
              </p>
            </div>
            <button
      ...
      {(activeTab === 'users' ||
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">
            {t('space.dashboard.coming_soon.title')}
          </h3>
          <p className="text-gray-500 dark:text-slate-400 max-w-sm mt-1">
            {t('space.dashboard.coming_soon.desc', {
