...
const EnhancedSearchInner: React.FC<EnhancedSearchRootProps> = memo(({
  ...
  const hasSubComponents = formChild || configChild || resultsChild || graphChild || errorChild || historyChild
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-slate-50 dark:bg-[#121520]">
        ...
        <div className="flex-1 flex overflow-hidden p-6 gap-6 pt-2">
          ...
          <div className="flex-1 flex flex-col gap-4 min-w-0 overflow-hidden">
            {/* Error Message */}
            {includeError && error && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 flex items-center gap-2" data-testid="search-error">
            ...
            {/* Search History */}
            {includeHistory && (
              <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-4" data-testid="search-history">
