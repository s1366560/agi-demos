...
const SearchModeButton = memo<SearchModeButtonProps>(({ mode, currentMode, onClick, icon, label }) => (
    <button
        onClick={onClick}
        className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 ${mode === currentMode
