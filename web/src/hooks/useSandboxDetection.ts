...
export interface SandboxDetectionResult {
  ...
  handleToolStart: (toolName: string, input: Record<string, unknown>, callId?: string) => void;
  /** Handle tool end event */
  handleToolEnd: (callId: string, output?: string, error?: string, durationMs?: number) => void;
  /** Open sandbox panel */
  openPanel: () => void;
  /** Close sandbox panel */
  closePanel: () => void;
...
export function useSandboxDetection(
  ...
  const handleToolStart = useCallback(
    (toolName: string, input: Record<string, unknown>, callId?: string) => {
  ...
  const handleToolEnd = useCallback(
    (callId: string, output?: string, error?: string, durationMs?: number) => {
