...
class MemStackClient:
    ...
    Example:
        ...
        ... )
        >>> results = client.search_memory("outdoor activities")
    """
    ...
    def revoke_api_key(self, key_id: str) -> None:
        """Revoke an API key."""
        self._make_request("DELETE", f"/api/v1/auth/keys/{key_id}")
    ...
    def list_memos(self, limit: int = 20, offset: int = 0) -> List[Memo]:
        """List memos."""
        response = self._make_request(
    ...
    def get_memo(self, memo_id: str) -> Memo:
        """Get a memo by ID."""
        response = self._make_request("GET", f"/api/v1/memos/{memo_id}")
        return Memo(**response)
    ...
    def delete_memo(self, memo_id: str) -> None:
        """Delete a memo."""
        self._make_request("DELETE", f"/api/v1/memos/{memo_id}")
