...
class CitationVerifier:
    ...
    def verify_url(self, url: str) -> tuple[bool, str]:
        ...
        try:
            ...
            req = request.Request(url, method="HEAD")  # noqa: S310
    ...
    def detect_hallucination_patterns(self, entry: dict) -> list[str]:
        ...
        if entry.get("year"):
            ...
            if year < 2000 and any(
                word in title.lower() for word in ["ai", "llm", "gpt", "transformer"]
            ):
                issues.append(
    ...
    def verify_entry(self, entry: dict) -> dict:  # noqa: C901, PLR0912
    ...
    def verify_all(self) -> bool:  # noqa: PLR0912
