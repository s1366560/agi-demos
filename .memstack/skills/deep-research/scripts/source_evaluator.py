...
class SourceEvaluator:
    ...
    HIGH_AUTHORITY_DOMAINS: ClassVar[set[str]] = {
        # Academic & Research
        "arxiv.org",
        "nature.com",
        "science.org",
    ...
    MODERATE_AUTHORITY_DOMAINS: ClassVar[set[str]] = {
        # Tech News & Analysis
        "techcrunch.com",
        "theverge.com",
        "arstechnica.com",
    ...
    LOW_AUTHORITY_INDICATORS: ClassVar[list[str]] = [
        "blogspot.com",
        "wordpress.com",
        "wix.com",
        "substack.com",
    ...
    def _evaluate_recency(self, publication_date: str | None) -> float:  # noqa: PLR0911
