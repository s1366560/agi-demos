...
class HTMLVerifier:
    ...
    def _check_sections(self, html: str, md: str) -> None:
    ...
    def _check_no_placeholders(self, html: str) -> None:
    ...
    def _check_no_emojis(self, html: str) -> None:
    ...
    def _check_structure(self, html: str) -> None:
    ...
    def _check_citations(self, html: str, md: str) -> None:
        ...
        html_content = (
            html.split('class="bibliography"')[0] if 'class="bibliography"' in html else html
        )
    ...
    def _check_bibliography(self, html: str, md: str) -> None:
